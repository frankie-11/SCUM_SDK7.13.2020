...
void AFireman_Helmet_03_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AFireman_Helmet_03_C_UpdateMaterialParamsOnClients_Params params;
...
void AFireman_Helmet_03_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AFireman_Helmet_03_C_SetDirtiness_Params params;
...
void AFireman_Helmet_03_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AFireman_Helmet_03_C_OnRep_MaterialParameters_Params params;
...
int AFireman_Helmet_03_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AFireman_Helmet_03_C_GetCapacityY_Params params;
...
int AFireman_Helmet_03_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AFireman_Helmet_03_C_GetCapacityX_Params params;
