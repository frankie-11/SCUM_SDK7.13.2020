...
void ASmall_Oxygen_Bottle_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ASmall_Oxygen_Bottle_C_UpdateMaterialParamsOnClients_Params params;
...
void ASmall_Oxygen_Bottle_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ASmall_Oxygen_Bottle_C_SetDirtiness_Params params;
...
void ASmall_Oxygen_Bottle_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ASmall_Oxygen_Bottle_C_OnRep_MaterialParameters_Params params;
...
int ASmall_Oxygen_Bottle_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	ASmall_Oxygen_Bottle_C_GetWarmth_Params params;
...
int ASmall_Oxygen_Bottle_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ASmall_Oxygen_Bottle_C_GetCapacityY_Params params;
...
int ASmall_Oxygen_Bottle_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ASmall_Oxygen_Bottle_C_GetCapacityX_Params params;
