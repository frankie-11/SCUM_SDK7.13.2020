...
void AMarine_Cap_05_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMarine_Cap_05_C_UpdateMaterialParamsOnClients_Params params;
...
void AMarine_Cap_05_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMarine_Cap_05_C_SetDirtiness_Params params;
...
void AMarine_Cap_05_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMarine_Cap_05_C_OnRep_MaterialParameters_Params params;
