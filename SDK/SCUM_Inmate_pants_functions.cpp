...
void AInmate_pants_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AInmate_pants_C_UpdateMaterialParamsOnClients_Params params;
...
void AInmate_pants_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AInmate_pants_C_SetDirtiness_Params params;
...
void AInmate_pants_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AInmate_pants_C_OnRep_MaterialParameters_Params params;
