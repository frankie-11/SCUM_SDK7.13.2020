...
public:
	...
	struct FName                                       LeftFootSocket;                                           // 0x255C(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FName                                       RightFootSocket;                                          // 0x2564(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      IsHoldingObject;                                          // 0x2578(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      IsVoiceActive;                                            // 0x2594(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      IgnorePenisPhysics;                                       // 0x2595(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void DebugPrint(struct FString* MessageString, struct FString* ValueString, float* Duration);
	void IKFootTraceToRemove(float* TraceDistance, struct FName* Socket, float* IKOffset);
