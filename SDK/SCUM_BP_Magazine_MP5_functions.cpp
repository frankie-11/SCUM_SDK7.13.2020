...
void ABP_Magazine_MP5_C::Server_InsertCartridgeIntoMagazine(class AAmmunitionItem** ammo)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Server_InsertCartridgeIntoMagazine");

	ABP_Magazine_MP5_C_Server_InsertCartridgeIntoMagazine_Params params;
	params.ammo = ammo;
...
void ABP_Magazine_MP5_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnRep_AmmoCountOwnerHelper");

	ABP_Magazine_MP5_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ABP_Magazine_MP5_C::Multicast_SetLoadedVariables(int* ammoCount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Multicast_SetLoadedVariables");

	ABP_Magazine_MP5_C_Multicast_SetLoadedVariables_Params params;
...
class UClass* ABP_Magazine_MP5_C::GetProjectileClass()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.GetProjectileClass");

	ABP_Magazine_MP5_C_GetProjectileClass_Params params;
