...
void AZombie_Baseball_Cap_18_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Baseball_Cap_18_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Baseball_Cap_18_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Baseball_Cap_18_C_SetDirtiness_Params params;
...
void AZombie_Baseball_Cap_18_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Baseball_Cap_18_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Baseball_Cap_18_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Baseball_Cap_18_C_GetWarmth_Params params;
...
int AZombie_Baseball_Cap_18_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Baseball_Cap_18_C_GetCapacityY_Params params;
...
int AZombie_Baseball_Cap_18_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Baseball_Cap_18_C_GetCapacityX_Params params;
