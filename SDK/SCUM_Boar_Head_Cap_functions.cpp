...
void ABoar_Head_Cap_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABoar_Head_Cap_C_UpdateMaterialParamsOnClients_Params params;
...
void ABoar_Head_Cap_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABoar_Head_Cap_C_SetDirtiness_Params params;
...
void ABoar_Head_Cap_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABoar_Head_Cap_C_OnRep_MaterialParameters_Params params;
