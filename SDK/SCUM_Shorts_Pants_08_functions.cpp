...
void AShorts_Pants_08_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AShorts_Pants_08_C_UpdateMaterialParamsOnClients_Params params;
...
void AShorts_Pants_08_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AShorts_Pants_08_C_SetDirtiness_Params params;
...
void AShorts_Pants_08_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AShorts_Pants_08_C_OnRep_MaterialParameters_Params params;
