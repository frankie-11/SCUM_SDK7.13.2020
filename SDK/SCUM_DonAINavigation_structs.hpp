...
struct FDoNNavigationQueryParams
{
	...
	unsigned char                                      bFlexibleOriginGoal;                                      // 0x0004(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSkipOptimizationPass;                                    // 0x0005(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	int                                                MaxOptimizerSweepAttemptsPerNode;                         // 0x0008(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPreciseDynamicCollisionRepathing;                        // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bIgnoreDynamicCollisionRepathingForDirectGoals;           // 0x000D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              CollisionShapeInflation;                                  // 0x0010(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bForceRescheduleQuery;                                    // 0x0014(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      DrawDebugVolumes;                                         // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      VisualizeRawPath;                                         // 0x0001(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      VisualizeOptimizedPath;                                   // 0x0002(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      VisualizeInRealTime;                                      // 0x0003(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      bVisualizePawnAsVoxels;                                   // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FDonNavigationQueryTask : public FDonNavigationTask
{
	...
	struct FScriptDelegate                             ResultHandler;                                            // 0x0298(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptDelegate                             DynamicCollisionListener;                                 // 0x02A8(0x0010) (ZeroConstructor, InstancedReference)
};
