...
// BlueprintGeneratedClass BP_MP5_Reload_Event.BP_MP5_Reload_Event_C
// 0x0000 (0x0088 - 0x0088)
class UBP_MP5_Reload_Event_C : public UEventInsertMagazine
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MP5_Reload_Event.BP_MP5_Reload_Event_C");
		return ptr;
	}
