...
public:
	...
	unsigned char                                      _isPrisonerInsideDoor;                                    // 0x0440(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void STATIC_PrisonerMoveInsideTimeline__FinishedFunc();
	void STATIC_PrisonerMoveInsideTimeline__UpdateFunc();
	void STATIC_ReceiveBeginPlay();
	void ReceiveTick(float* DeltaSeconds);
	void StartPrisonerEnterSequence(bool* backwards);
	void BndEvt__Sparks1_K2Node_ComponentBoundEvent_1_ParticleBurstSignature__DelegateSignature(struct FName* EventName, float* EmitterTime, int* ParticleCount);
	...
	void BndEvt__Smoke4_K2Node_ComponentBoundEvent_3_ParticleBurstSignature__DelegateSignature(struct FName* EventName, float* EmitterTime, int* ParticleCount);
