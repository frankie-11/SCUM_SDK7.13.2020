...
void AMilitary_Shirt_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitary_Shirt_02_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitary_Shirt_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitary_Shirt_02_C_SetDirtiness_Params params;
...
void AMilitary_Shirt_02_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitary_Shirt_02_C_OnRep_MaterialParameters_Params params;
...
int AMilitary_Shirt_02_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AMilitary_Shirt_02_C_GetCapacityY_Params params;
...
int AMilitary_Shirt_02_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AMilitary_Shirt_02_C_GetCapacityX_Params params;
