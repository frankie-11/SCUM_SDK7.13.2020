...
void ANight_Vision_Helmet_Down_07_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ANight_Vision_Helmet_Down_07_C_UpdateMaterialParamsOnClients_Params params;
...
void ANight_Vision_Helmet_Down_07_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ANight_Vision_Helmet_Down_07_C_SetDirtiness_Params params;
...
void ANight_Vision_Helmet_Down_07_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ANight_Vision_Helmet_Down_07_C_OnRep_MaterialParameters_Params params;
...
int ANight_Vision_Helmet_Down_07_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	ANight_Vision_Helmet_Down_07_C_GetWarmth_Params params;
...
int ANight_Vision_Helmet_Down_07_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ANight_Vision_Helmet_Down_07_C_GetCapacityY_Params params;
...
int ANight_Vision_Helmet_Down_07_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ANight_Vision_Helmet_Down_07_C_GetCapacityX_Params params;
