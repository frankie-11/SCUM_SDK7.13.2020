...
void AHalloween_Mask_Smiley_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHalloween_Mask_Smiley_C_UpdateMaterialParamsOnClients_Params params;
...
void AHalloween_Mask_Smiley_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHalloween_Mask_Smiley_C_SetDirtiness_Params params;
...
void AHalloween_Mask_Smiley_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AHalloween_Mask_Smiley_C_OnRep_MaterialParameters_Params params;
...
int AHalloween_Mask_Smiley_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AHalloween_Mask_Smiley_C_GetWarmth_Params params;
...
int AHalloween_Mask_Smiley_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AHalloween_Mask_Smiley_C_GetCapacityY_Params params;
...
int AHalloween_Mask_Smiley_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AHalloween_Mask_Smiley_C_GetCapacityX_Params params;
