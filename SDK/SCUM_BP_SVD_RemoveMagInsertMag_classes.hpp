...
// BlueprintGeneratedClass BP_SVD_RemoveMagInsertMag.BP_SVD_RemoveMagInsertMag_C
// 0x0000 (0x0088 - 0x0088)
class UBP_SVD_RemoveMagInsertMag_C : public URemoveMagazineInsertMagazine
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_SVD_RemoveMagInsertMag.BP_SVD_RemoveMagInsertMag_C");
		return ptr;
	}
