...
struct FJoinabilitySettings
{
	...
	unsigned char                                      bPublicSearchable;                                        // 0x0008(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAllowInvites;                                            // 0x0009(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bJoinViaPresence;                                         // 0x000A(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bJoinViaPresenceFriendsOnly;                              // 0x000B(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FInterpCurveFloat
{
	...
	unsigned char                                      bIsLooped;                                                // 0x0010(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
struct FTimecode
{
	...
	unsigned char                                      bDropFrameFormat;                                         // 0x0010(0x0001) (BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FPolyglotTextData
{
	...
	unsigned char                                      bIsMinimalPatch;                                          // 0x0098(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FText                                       CachedText;                                               // 0x00A0(0x0018) (Transient)
};
