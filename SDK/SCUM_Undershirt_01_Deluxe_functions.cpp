...
void AUndershirt_01_Deluxe_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AUndershirt_01_Deluxe_C_UpdateMaterialParamsOnClients_Params params;
...
void AUndershirt_01_Deluxe_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AUndershirt_01_Deluxe_C_SetDirtiness_Params params;
...
void AUndershirt_01_Deluxe_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AUndershirt_01_Deluxe_C_OnRep_MaterialParameters_Params params;
...
int AUndershirt_01_Deluxe_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AUndershirt_01_Deluxe_C_GetWarmth_Params params;
...
int AUndershirt_01_Deluxe_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AUndershirt_01_Deluxe_C_GetCapacityY_Params params;
...
int AUndershirt_01_Deluxe_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AUndershirt_01_Deluxe_C_GetCapacityX_Params params;
