...
void ALeather_Shoes_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ALeather_Shoes_C_UpdateMaterialParamsOnClients_Params params;
...
void ALeather_Shoes_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ALeather_Shoes_C_SetDirtiness_Params params;
...
void ALeather_Shoes_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ALeather_Shoes_C_OnRep_MaterialParameters_Params params;
