...
void AHoodie_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHoodie_02_C_UpdateMaterialParamsOnClients_Params params;
...
void AHoodie_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHoodie_02_C_SetDirtiness_Params params;
