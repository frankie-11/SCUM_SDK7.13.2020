...
void A12_Gauge_FlareCartridge_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	A12_Gauge_FlareCartridge_C_SetAmmoCount_Params params;
	params.count = count;
...
void A12_Gauge_FlareCartridge_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCountOwnerHelper");

	A12_Gauge_FlareCartridge_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void A12_Gauge_FlareCartridge_C::OnRep_AmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCount");

	A12_Gauge_FlareCartridge_C_OnRep_AmmoCount_Params params;
...
int A12_Gauge_FlareCartridge_C::GetAmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.GetAmmoCount");

	A12_Gauge_FlareCartridge_C_GetAmmoCount_Params params;
...
void A12_Gauge_FlareCartridge_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	A12_Gauge_FlareCartridge_C_Client_SetAmmoCount_Params params;
	params.count = count;
