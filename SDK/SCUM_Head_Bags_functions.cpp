...
void AHead_Bags_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHead_Bags_C_UpdateMaterialParamsOnClients_Params params;
...
void AHead_Bags_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHead_Bags_C_SetDirtiness_Params params;
