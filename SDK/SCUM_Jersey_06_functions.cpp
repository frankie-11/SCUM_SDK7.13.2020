...
void AJersey_06_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AJersey_06_C_UpdateMaterialParamsOnClients_Params params;
...
void AJersey_06_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AJersey_06_C_SetDirtiness_Params params;
