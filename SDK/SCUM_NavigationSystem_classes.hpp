...
public:
	...
	unsigned char                                      UnknownData04[0x11C];                                     // 0x00E0(0x011C) MISSED OFFSET
	EFNavigationSystemRunMode                          OperationMode;                                            // 0x01FC(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData05[0x357];                                     // 0x01FD(0x0357) MISSED OFFSET
	float                                              DirtyAreasUpdateFreq;                                     // 0x0554(0x0004) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      UnknownData06[0x20];                                      // 0x0558(0x0020) MISSED OFFSET
