...
public:
	...
	struct FText                                       TextFormat;                                               // 0x02C0(0x0018) (Edit, BlueprintVisible)
	struct FText                                       ParameterText;                                            // 0x02D8(0x0018) (Edit, BlueprintVisible)
	...
	void STATIC_OnTextDataChanged(struct FText* Value);
	void STATIC_PreConstruct(bool* IsDesignTime);
	void STATIC_OnNumberDataChanged(float* Value);
