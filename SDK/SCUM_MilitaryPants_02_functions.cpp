...
void AMilitaryPants_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitaryPants_02_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitaryPants_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitaryPants_02_C_SetDirtiness_Params params;
...
void AMilitaryPants_02_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitaryPants_02_C_OnRep_MaterialParameters_Params params;
...
int AMilitaryPants_02_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AMilitaryPants_02_C_GetCapacityY_Params params;
...
int AMilitaryPants_02_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AMilitaryPants_02_C_GetCapacityX_Params params;
