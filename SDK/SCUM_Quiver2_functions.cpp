...
bool AQuiver2_C::Use(class APrisoner** Prisoner, int* usage, float* usageWeight, bool* Eat, float* damageMultiplier)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Use");

	AQuiver2_C_Use_Params params;
...
void AQuiver2_C::UpdateVisuals(bool* shouldHandleAging)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.UpdateVisuals");

	AQuiver2_C_UpdateVisuals_Params params;
...
void AQuiver2_C::StaticMeshChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.StaticMeshChangedDelegate__DelegateSignature");

	AQuiver2_C_StaticMeshChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void AQuiver2_C::SkeletalMeshChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.SkeletalMeshChangedDelegate__DelegateSignature");

	AQuiver2_C_SkeletalMeshChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void AQuiver2_C::SetMaxHealth(float* maxHealth)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetMaxHealth");

	AQuiver2_C_SetMaxHealth_Params params;
...
void AQuiver2_C::SetHealthAndUsage(float* health, int* usage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetHealthAndUsage");

	AQuiver2_C_SetHealthAndUsage_Params params;
...
void AQuiver2_C::SetHealth(float* health)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetHealth");

	AQuiver2_C_SetHealth_Params params;
	params.health = health;
...
void AQuiver2_C::Server_Throw(struct FVector* ZeroBasedStartPosition, struct FRotator* StartRotation, struct FVector* StartVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Server_Throw");

	AQuiver2_C_Server_Throw_Params params;
...
void AQuiver2_C::Repair(float* healthToRepair)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Repair");

	AQuiver2_C_Repair_Params params;
...
TScriptInterface<class UInventoryNode> AQuiver2_C::RemoveStacks(int* stacksToSplit)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.RemoveStacks");

	AQuiver2_C_RemoveStacks_Params params;
...
void AQuiver2_C::PickedUpStateDelegate__DelegateSignature(class AItem** Item, bool* pickedUp)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.PickedUpStateDelegate__DelegateSignature");

	AQuiver2_C_PickedUpStateDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void AQuiver2_C::OnRep_InventoryContainer2D()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnRep_InventoryContainer2D");

	AQuiver2_C_OnRep_InventoryContainer2D_Params params;
...
void AQuiver2_C::OnProjectileStop(struct FHitResult* ImpactResult)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnProjectileStop");

	AQuiver2_C_OnProjectileStop_Params params;
...
void AQuiver2_C::OnLocalPrisonerPanelsClosed()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnLocalPrisonerPanelsClosed");

	AQuiver2_C_OnLocalPrisonerPanelsClosed_Params params;
...
void AQuiver2_C::OnLocalPrisonerHoveredActorChanged(class AActor** hoveredActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnLocalPrisonerHoveredActorChanged");

	AQuiver2_C_OnLocalPrisonerHoveredActorChanged_Params params;
...
void AQuiver2_C::OnEditTextWidgetTextAccepted(class APrisoner** User, struct FText* Text)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnEditTextWidgetTextAccepted");

	AQuiver2_C_OnEditTextWidgetTextAccepted_Params params;
	params.User = User;
	params.Text = Text;
...
void AQuiver2_C::OnDetachedFromItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnDetachedFromItem");

	AQuiver2_C_OnDetachedFromItem_Params params;
	params.Item = Item;
...
void AQuiver2_C::OnDestroyedEvent(class AActor** Self)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnDestroyedEvent");

	AQuiver2_C_OnDestroyedEvent_Params params;
	params.Self = Self;
...
void AQuiver2_C::OnContainedItemDestroyed(class AActor** containedItem)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnContainedItemDestroyed");

	AQuiver2_C_OnContainedItemDestroyed_Params params;
...
void AQuiver2_C::OnAttachedToItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnAttachedToItem");

	AQuiver2_C_OnAttachedToItem_Params params;
	params.Item = Item;
...
void AQuiver2_C::NetMulticast_SpawnDestroyedEffects()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SpawnDestroyedEffects");

	AQuiver2_C_NetMulticast_SpawnDestroyedEffects_Params params;
...
void AQuiver2_C::NetMulticast_SetPlayerGivenName(struct FString* Value)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SetPlayerGivenName");

	AQuiver2_C_NetMulticast_SetPlayerGivenName_Params params;
	params.Value = Value;
...
void AQuiver2_C::NetMulticast_SetActorDropLocationAndRotation(struct FVector* Location, struct FRotator* Rotation)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SetActorDropLocationAndRotation");

	AQuiver2_C_NetMulticast_SetActorDropLocationAndRotation_Params params;
...
void AQuiver2_C::Multicast_UpdateExpirationTime(int64_t* Time)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Multicast_UpdateExpirationTime");

	AQuiver2_C_Multicast_UpdateExpirationTime_Params params;
	params.Time = Time;
...
void AQuiver2_C::Multicast_Throw(struct FVector* ZeroBasedStartPosition, struct FRotator* StartRotation, struct FVector* StartVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Multicast_Throw");

	AQuiver2_C_Multicast_Throw_Params params;
	params.ZeroBasedStartPosition = ZeroBasedStartPosition;
	params.StartRotation = StartRotation;
	params.StartVelocity = StartVelocity;
...
bool AQuiver2_C::HasPriorityForContainerItem(class AItem** containerItem)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.HasPriorityForContainerItem");

	AQuiver2_C_HasPriorityForContainerItem_Params params;
...
struct FWidgetDisplayInfo AQuiver2_C::GetWidgetDisplayInfo()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetWidgetDisplayInfo");

	AQuiver2_C_GetWidgetDisplayInfo_Params params;
...
float AQuiver2_C::GetNoiseLoudnessWhenPickedUp()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessWhenPickedUp");

	AQuiver2_C_GetNoiseLoudnessWhenPickedUp_Params params;
...
float AQuiver2_C::GetNoiseLoudnessWhenDropped()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessWhenDropped");

	AQuiver2_C_GetNoiseLoudnessWhenDropped_Params params;
...
float AQuiver2_C::GetNoiseLoudnessOnGroundImpact()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessOnGroundImpact");

	AQuiver2_C_GetNoiseLoudnessOnGroundImpact_Params params;
...
class UMeshComponent* AQuiver2_C::GetMeshComponent()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetMeshComponent");

	AQuiver2_C_GetMeshComponent_Params params;
...
float AQuiver2_C::GetContainerDamagePercentage()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetContainerDamagePercentage");

	AQuiver2_C_GetContainerDamagePercentage_Params params;
...
TArray<class AItem*> AQuiver2_C::GetAllContainedItems(bool* recursive)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetAllContainedItems");

	AQuiver2_C_GetAllContainedItems_Params params;
...
bool AQuiver2_C::DropAt(struct FVector* dropLocation, struct FRotator* dropRotation)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.DropAt");

	AQuiver2_C_DropAt_Params params;
...
bool AQuiver2_C::DropAround(class AActor** Actor, float* Radius)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.DropAround");

	AQuiver2_C_DropAround_Params params;
	params.Actor = Actor;
...
void AQuiver2_C::DebugTextChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.DebugTextChangedDelegate__DelegateSignature");

	AQuiver2_C_DebugTextChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
bool AQuiver2_C::CanStackWith(class UObject** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanStackWith");

	AQuiver2_C_CanStackWith_Params params;
	params.Item = Item;
...
bool AQuiver2_C::CanBeDroppedBy(class AConZCharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanBeDroppedBy");

	AQuiver2_C_CanBeDroppedBy_Params params;
...
bool AQuiver2_C::CanBeCraftedByCharactrer(class ACharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanBeCraftedByCharactrer");

	AQuiver2_C_CanBeCraftedByCharactrer_Params params;
	params.Character = Character;
...
bool AQuiver2_C::CanAutoAddItem(class AItem** Item, unsigned char* column, unsigned char* row)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanAutoAddItem");

	AQuiver2_C_CanAutoAddItem_Params params;
	params.Item = Item;
...
bool AQuiver2_C::CanAddItem(class AItem** Item, unsigned char* column, unsigned char* row)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanAddItem");

	AQuiver2_C_CanAddItem_Params params;
	params.Item = Item;
...
bool AQuiver2_C::AutoAddItemToInventoryNode(TScriptInterface<class UInventoryNode>* Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AutoAddItemToInventoryNode");

	AQuiver2_C_AutoAddItemToInventoryNode_Params params;
	params.Item = Item;
...
bool AQuiver2_C::AttachToCharacterHands(class AConZCharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AttachToCharacterHands");

	AQuiver2_C_AttachToCharacterHands_Params params;
	params.Character = Character;
...
void AQuiver2_C::AddStack(TScriptInterface<class UInventoryNode>* Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AddStack");

	AQuiver2_C_AddStack_Params params;
	params.Item = Item;
