...
public:
	...
	unsigned char                                      bHasRecordedData;                                         // 0x0118(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x6F];                                      // 0x0139(0x006F) MISSED OFFSET
...
public:
	...
	class USceneComponent*                             SceneComponent;                                           // 0x0230(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
...
public:
	struct FText                                       DisplayText;                                              // 0x0028(0x0018) (Deprecated)
	unsigned char                                      UnknownData00[0x18];                                      // 0x0040(0x0018) MISSED OFFSET
	unsigned char                                      bExpanded;                                                // 0x0058(0x0001) (ZeroConstructor, IsPlainOldData)
