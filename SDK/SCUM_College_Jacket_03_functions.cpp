...
void ACollege_Jacket_03_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ACollege_Jacket_03_C_UpdateMaterialParamsOnClients_Params params;
...
void ACollege_Jacket_03_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ACollege_Jacket_03_C_SetDirtiness_Params params;
...
void ACollege_Jacket_03_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ACollege_Jacket_03_C_OnRep_MaterialParameters_Params params;
...
int ACollege_Jacket_03_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ACollege_Jacket_03_C_GetCapacityY_Params params;
...
int ACollege_Jacket_03_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ACollege_Jacket_03_C_GetCapacityX_Params params;
