...
void ABeenie_08_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABeenie_08_C_UpdateMaterialParamsOnClients_Params params;
...
void ABeenie_08_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABeenie_08_C_SetDirtiness_Params params;
