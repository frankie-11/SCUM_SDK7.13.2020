...
void ABeenie_3_hole_08_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABeenie_3_hole_08_C_UpdateMaterialParamsOnClients_Params params;
...
void ABeenie_3_hole_08_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABeenie_3_hole_08_C_SetDirtiness_Params params;
...
void ABeenie_3_hole_08_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABeenie_3_hole_08_C_OnRep_MaterialParameters_Params params;
...
int ABeenie_3_hole_08_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ABeenie_3_hole_08_C_GetCapacityY_Params params;
...
int ABeenie_3_hole_08_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ABeenie_3_hole_08_C_GetCapacityX_Params params;
