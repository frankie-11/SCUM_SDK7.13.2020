...
void AImprovised_Bag_Small_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AImprovised_Bag_Small_01_C_UpdateMaterialParamsOnClients_Params params;
...
void AImprovised_Bag_Small_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AImprovised_Bag_Small_01_C_SetDirtiness_Params params;
...
void AImprovised_Bag_Small_01_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AImprovised_Bag_Small_01_C_OnRep_MaterialParameters_Params params;
...
int AImprovised_Bag_Small_01_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AImprovised_Bag_Small_01_C_GetWarmth_Params params;
...
int AImprovised_Bag_Small_01_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AImprovised_Bag_Small_01_C_GetCapacityY_Params params;
...
int AImprovised_Bag_Small_01_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AImprovised_Bag_Small_01_C_GetCapacityX_Params params;
