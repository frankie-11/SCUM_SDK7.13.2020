...
public:
	...
	unsigned char                                      bSpecifyRadius;                                           // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bInBrushStroke;                                           // 0x0070(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bCalculateNormals;                                        // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0x240];                                     // 0x0070(0x0240) MISSED OFFSET
...
public:
	...
	unsigned char                                      bAllowSelfIntersections;                                  // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bShowGizmo;                                               // 0x0055(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      bEnableSnapping;                                          // 0x0048(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSnapToVertices;                                          // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSnapToEdges;                                             // 0x004A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSnapToAngles;                                            // 0x004B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSnapToLengths;                                           // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SegmentLength;                                            // 0x0050(0x0004) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
	unsigned char                                      bHitSceneObjects;                                         // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData02[0x6C8];                                     // 0x0108(0x06C8) MISSED OFFSET
...
public:
	...
	unsigned char                                      bPreserveUVFlow;                                          // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              BrushDepth;                                               // 0x0058(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFreezeTarget;                                            // 0x005C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bRemeshSmooth;                                            // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFlips;                                                   // 0x0051(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSplits;                                                  // 0x0052(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCollapses;                                               // 0x0053(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPreventNormalFlips;                                      // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bSelectFaces;                                             // 0x004A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSelectEdges;                                             // 0x004B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSelectVertices;                                          // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bWireframe;                                               // 0x004D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0054(0x0003) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	double                                             HandleWeight;                                             // 0x0058(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPostFixHandles;                                          // 0x0060(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      bRecomputeNormals;                                        // 0x0048(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	ENormalCalculationMethod                           NormalCalculationMethod;                                  // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFixInconsistentNormals;                                  // 0x004A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bInvertNormals;                                           // 0x004B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bRecomputeNormalTopologyAndEdgeSharpness;                 // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SharpEdgeAngleThreshold;                                  // 0x0050(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAllowSharpVertices;                                      // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      bWireframe;                                               // 0x0048(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bBoundaryEdges;                                           // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPolygonBorders;                                          // 0x004A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUVSeams;                                                 // 0x004B(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bNormalSeams;                                             // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bNormalVectors;                                           // 0x004D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bTangentVectors;                                          // 0x004E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bWorldSpaceUVScale;                                       // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bWireframe;                                               // 0x0055(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      bShowWireframe;                                           // 0x0048(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EMeshEditingMaterialModes                          MaterialMode;                                             // 0x004C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0049(0x0003) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData00[0x3];                                       // 0x0048(0x0003) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	float                                              AngleTolerance;                                           // 0x004C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bVolumetricBrush;                                         // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bHitBackFaces;                                            // 0x0051(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bShowWireframe;                                           // 0x0052(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      UnknownData00[0xC50];                                     // 0x0090(0x0C50) MISSED OFFSET
...
{
public:
	unsigned char                                      bDiscardAttributes;                                       // 0x0048(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bKeepBothHalves;                                          // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              SpacingBetweenHalves;                                     // 0x004C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFillCutHole;                                             // 0x0050(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bShowPreview;                                             // 0x0051(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFillSpans;                                               // 0x0052(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bCutBackSide;                                             // 0x0038(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bDiscardAttributes;                                       // 0x0058(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPreserveSharpEdges;                                      // 0x0059(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseTargetEdgeLength;                                     // 0x005A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	float                                              TargetEdgeLength;                                         // 0x005C(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFlips;                                                   // 0x0060(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSplits;                                                  // 0x0061(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bCollapses;                                               // 0x0062(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bReproject;                                               // 0x0063(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bPreventNormalFlips;                                      // 0x0064(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UMeshOpPreviewWithBackgroundCompute*         Preview;                                                  // 0x0070(0x0008) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData01[0x208];                                     // 0x0078(0x0208) MISSED OFFSET
...
public:
	...
	unsigned char                                      bSetPivot;                                                // 0x0049(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bEnableSnapDragging;                                      // 0x004A(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bWorldSpaceUVScale;                                       // 0x006C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bOnlyUnique;                                              // 0x005C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
