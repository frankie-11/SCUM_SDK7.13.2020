...
void AImprovised_Mask_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AImprovised_Mask_C_UpdateMaterialParamsOnClients_Params params;
...
void AImprovised_Mask_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AImprovised_Mask_C_SetDirtiness_Params params;
...
void AImprovised_Mask_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AImprovised_Mask_C_OnRep_MaterialParameters_Params params;
