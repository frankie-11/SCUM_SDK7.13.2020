...
{
public:
	unsigned char                                      bUseSpatialAudio;                                         // 0x01F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      EnableSpotReflectors : 1;                                 // 0x0224(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0101)
	...
	unsigned char                                      DrawFirstOrderReflections : 1;                            // 0x0238(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      DrawSecondOrderReflections : 1;                           // 0x0238(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      DrawHigherOrderReflections : 1;                           // 0x0238(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      DrawGeometricDiffraction : 1;                             // 0x0238(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      DrawSoundPropagation : 1;                                 // 0x0238(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
	unsigned char                                      UnknownData00[0x3];                                       // 0x0239(0x0003) MISSED OFFSET
	unsigned char                                      StopWhenOwnerDestroyed;                                   // 0x023C(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData01[0x170];                                     // 0x0260(0x0170) MISSED OFFSET
...
public:
	...
	struct FScriptDelegate                             CheckedStateDelegate;                                     // 0x04AC(0x0010) (ZeroConstructor, InstancedReference)
	...
	unsigned char                                      IsFocusable;                                              // 0x0A41(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	struct FScriptMulticastDelegate                    AkOnCheckStateChanged;                                    // 0x0A98(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0A98(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnItemDropped;                                            // 0x0AA8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x0AA8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnPropertyDropped;                                        // 0x0AB8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0xF];                                       // 0x0AB8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	unsigned char                                      bEnable : 1;                                              // 0x01F0(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
...
public:
	...
	unsigned char                                      SuppressWwiseProjectPathWarnings;                         // 0x0048(0x0001) (ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	unsigned char                                      bEnableSurfaceReflectors : 1;                             // 0x01F0(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	TArray<struct FAkPoly>                             AcousticPolys;                                            // 0x01F8(0x0010) (Edit, BlueprintVisible, ZeroConstructor)
	unsigned char                                      bEnableDiffraction : 1;                                   // 0x0208(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bEnableDiffractionOnBoundaryEdges : 1;                    // 0x0208(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      UnknownData00[0x17];                                      // 0x0209(0x0017) MISSED OFFSET
