...
public:
	...
	unsigned char                                      bDisableLowLatencyUpdate : 1;                             // 0x03E8(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	ETrackingStatus                                    CurrentTrackingStatus;                                    // 0x03EC(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDisplayDeviceModel;                                      // 0x03ED(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
