...
public:
	...
	struct FLiveLinkSourceBufferManagementSettings     BufferSettings;                                           // 0x002C(0x0030) (Edit)
...
{
public:
	struct FLiveLinkCurveConversionSettings            CurveConversionSettings;                                  // 0x0078(0x0050) (Edit, Config)
