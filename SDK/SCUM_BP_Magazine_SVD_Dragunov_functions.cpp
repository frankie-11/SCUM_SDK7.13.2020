...
void ABP_Magazine_SVD_Dragunov_C::SetAmmoCount(int* Amount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.SetAmmoCount");

	ABP_Magazine_SVD_Dragunov_C_SetAmmoCount_Params params;
...
void ABP_Magazine_SVD_Dragunov_C::Server_InsertCartridgeIntoMagazine(class AAmmunitionItem** ammo)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Server_InsertCartridgeIntoMagazine");

	ABP_Magazine_SVD_Dragunov_C_Server_InsertCartridgeIntoMagazine_Params params;
	params.ammo = ammo;
...
void ABP_Magazine_SVD_Dragunov_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnRep_AmmoCountOwnerHelper");

	ABP_Magazine_SVD_Dragunov_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ABP_Magazine_SVD_Dragunov_C::OnRep_AmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnRep_AmmoCount");

	ABP_Magazine_SVD_Dragunov_C_OnRep_AmmoCount_Params params;
...
void ABP_Magazine_SVD_Dragunov_C::OnAmmoChangedEvent()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnAmmoChangedEvent");

	ABP_Magazine_SVD_Dragunov_C_OnAmmoChangedEvent_Params params;
...
void ABP_Magazine_SVD_Dragunov_C::Multicast_SetLoadedVariables(int* ammoCount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Multicast_SetLoadedVariables");

	ABP_Magazine_SVD_Dragunov_C_Multicast_SetLoadedVariables_Params params;
...
class UClass* ABP_Magazine_SVD_Dragunov_C::GetProjectileClass()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.GetProjectileClass");

	ABP_Magazine_SVD_Dragunov_C_GetProjectileClass_Params params;
...
int ABP_Magazine_SVD_Dragunov_C::GetCapacity()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.GetCapacity");

	ABP_Magazine_SVD_Dragunov_C_GetCapacity_Params params;
...
int ABP_Magazine_SVD_Dragunov_C::GetAmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.GetAmmoCount");

	ABP_Magazine_SVD_Dragunov_C_GetAmmoCount_Params params;
...
void ABP_Magazine_SVD_Dragunov_C::AddAmmo(int* Amount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.AddAmmo");

	ABP_Magazine_SVD_Dragunov_C_AddAmmo_Params params;
	params.Amount = Amount;
