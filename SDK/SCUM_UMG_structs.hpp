...
{
	unsigned char                                      bOverride_TextShapingMethod : 1;                          // 0x0000(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bOverride_TextFlowDirection : 1;                          // 0x0000(0x0001) (Edit BITFIELD: 0202)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      bIsRootWidget;                                            // 0x0020(0x0001) (ZeroConstructor, IsPlainOldData)
};
