...
public:
	...
	struct FScriptMulticastDelegate                    OnClickedDispatcher;                                      // 0x0298(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0298(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
