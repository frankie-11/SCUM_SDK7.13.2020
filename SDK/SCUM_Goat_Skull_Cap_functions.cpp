...
void AGoat_Skull_Cap_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AGoat_Skull_Cap_C_UpdateMaterialParamsOnClients_Params params;
...
void AGoat_Skull_Cap_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AGoat_Skull_Cap_C_SetDirtiness_Params params;
...
void AGoat_Skull_Cap_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AGoat_Skull_Cap_C_OnRep_MaterialParameters_Params params;
