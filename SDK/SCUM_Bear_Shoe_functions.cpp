...
void ABear_Shoe_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABear_Shoe_C_UpdateMaterialParamsOnClients_Params params;
...
void ABear_Shoe_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABear_Shoe_C_SetDirtiness_Params params;
