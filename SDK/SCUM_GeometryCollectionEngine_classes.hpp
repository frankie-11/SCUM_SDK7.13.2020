...
{
public:
	unsigned char                                      bIsCollisionEventListeningEnabled : 1;                    // 0x01F0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0101)
	unsigned char                                      bIsBreakingEventListeningEnabled : 1;                     // 0x01F0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0202)
	unsigned char                                      bIsTrailingEventListeningEnabled : 1;                     // 0x01F0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0404)
	...
	unsigned char                                      UnknownData00[0x50];                                      // 0x023C(0x0050) UNKNOWN PROPERTY: SetProperty GeometryCollectionEngine.ChaosDestructionListener.ChaosSolverActors
	unsigned char                                      UnknownData01[0x50];                                      // 0x0290(0x0050) UNKNOWN PROPERTY: SetProperty GeometryCollectionEngine.ChaosDestructionListener.GeometryCollectionActors
	struct FScriptMulticastDelegate                    OnCollisionEvents;                                        // 0x02E0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x02E0(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnBreakingEvents;                                         // 0x02F0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0xF];                                       // 0x02F0(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnTrailingEvents;                                         // 0x0300(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData04[0xF];                                       // 0x0300(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData05[0x110];                                     // 0x0310(0x0110) MISSED OFFSET
...
public:
	...
	unsigned char                                      Simulating;                                               // 0x0508(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EObjectStateTypeEnum                               ObjectType;                                               // 0x0510(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      EnableClustering;                                         // 0x0511(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FScriptMulticastDelegate                    NotifyGeometryCollectionPhysicsStateChange;               // 0x05B8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x05B8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    NotifyGeometryCollectionPhysicsLoadingStateChange;        // 0x05C8(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData03[0xF];                                       // 0x05C8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData04[0x18];                                      // 0x05D8(0x0018) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnChaosBreakEvent;                                        // 0x05F0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData05[0xF];                                       // 0x05D8(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	float                                              DesiredCacheTime;                                         // 0x0600(0x0004) (Edit, BlueprintVisible, ZeroConstructor, Transient, EditConst, IsPlainOldData)
	unsigned char                                      CachePlayback;                                            // 0x0604(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Transient, EditConst, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnChaosPhysicsCollision;                                  // 0x0608(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData06[0xF];                                       // 0x0605(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      bNotifyBreaks;                                            // 0x0618(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bNotifyCollisions;                                        // 0x0619(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData07[0x1AE];                                     // 0x061A(0x01AE) MISSED OFFSET
	class UBodySetup*                                  DummyBodySetup;                                           // 0x07C8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData08[0x20];                                      // 0x07D0(0x0020) MISSED OFFSET
