...
// (Net, NetRequest, Exec, Native, NetResponse, Static, NetMulticast, Public, Private, Delegate, NetServer, NetClient, BlueprintEvent, Const, NetValidate)
// Parameters:
// struct FText*                  Value                          (BlueprintVisible, BlueprintReadOnly, Parm)

void UUI_CriminalRecordText_C::STATIC_SetValue(struct FText* Value)
{
...
// (NetReliable, Exec, Native, NetResponse, Static, NetMulticast, Public, Private, Delegate, NetServer, NetClient, BlueprintEvent, Const, NetValidate)

void UUI_CriminalRecordText_C::STATIC_OnSynchronizeProperties()
{
...
// (NetReliable, Native, Event, NetResponse, Delegate, HasOutParms, NetClient, DLLImport)
// Parameters:
