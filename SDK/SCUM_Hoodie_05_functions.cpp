...
void AHoodie_05_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHoodie_05_C_UpdateMaterialParamsOnClients_Params params;
...
void AHoodie_05_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHoodie_05_C_SetDirtiness_Params params;
