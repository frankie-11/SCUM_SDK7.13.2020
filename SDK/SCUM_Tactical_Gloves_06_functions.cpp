...
void ATactical_Gloves_06_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ATactical_Gloves_06_C_UpdateMaterialParamsOnClients_Params params;
...
void ATactical_Gloves_06_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ATactical_Gloves_06_C_SetDirtiness_Params params;
...
void ATactical_Gloves_06_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ATactical_Gloves_06_C_OnRep_MaterialParameters_Params params;
...
int ATactical_Gloves_06_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	ATactical_Gloves_06_C_GetWarmth_Params params;
...
int ATactical_Gloves_06_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ATactical_Gloves_06_C_GetCapacityY_Params params;
...
int ATactical_Gloves_06_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ATactical_Gloves_06_C_GetCapacityX_Params params;
