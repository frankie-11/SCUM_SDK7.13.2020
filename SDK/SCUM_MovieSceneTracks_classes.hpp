...
public:
	...
	EAttachmentRule                                    AttachmentLocationRule;                                   // 0x0118(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentRotationRule;                                   // 0x0119(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EAttachmentRule                                    AttachmentScaleRule;                                      // 0x011A(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentLocationRule;                                   // 0x011B(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentRotationRule;                                   // 0x011C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EDetachmentRule                                    DetachmentScaleRule;                                      // 0x011D(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	EMovieScene3DPathSection_Axis                      FrontAxisEnum;                                            // 0x01A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	EMovieScene3DPathSection_Axis                      UpAxisEnum;                                               // 0x01A9(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFollow : 1;                                              // 0x01AC(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bReverse : 1;                                             // 0x01AC(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      bForceUpright : 1;                                        // 0x01AC(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
...
public:
	...
	unsigned char                                      UnknownData00[0x4];                                       // 0x0728(0x0004) MISSED OFFSET
	unsigned char                                      bUseQuaternionInterpolation;                              // 0x072C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
{
public:
	class UMovieSceneSection*                          SectionToKey;                                             // 0x0058(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FIntegralCurve                              ActorGuidIndexCurve;                                      // 0x0180(0x0080) (Deprecated)
...
public:
	...
	struct FMovieSceneFloatChannel                     SoundVolume;                                              // 0x0100(0x00A0)
	struct FMovieSceneFloatChannel                     PitchMultiplier;                                          // 0x01A0(0x00A0)
	unsigned char                                      bSuppressSubtitles;                                       // 0x0240(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bOverrideAttenuation;                                     // 0x0241(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	class USoundAttenuation*                           AttenuationSettings;                                      // 0x0248(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	struct FScriptDelegate                             OnQueueSubtitles;                                         // 0x0250(0x0010) (ZeroConstructor, InstancedReference)
	struct FScriptMulticastDelegate                    OnAudioFinished;                                          // 0x0260(0x0001) (ZeroConstructor, InstancedReference)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0260(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnAudioPlaybackPercent;                                   // 0x0270(0x0001) (ZeroConstructor, InstancedReference)
...
{
public:
	unsigned char                                      DefaultValue;                                             // 0x00E0(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
public:
	...
	unsigned char                                      bLooping;                                                 // 0x0118(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	unsigned char                                      bIsSlateColor;                                            // 0x0088(0x0001) (ZeroConstructor, Deprecated, IsPlainOldData)
...
{
public:
	struct FMovieSceneEvent                            Event;                                                    // 0x00E0(0x0010) (Edit)
...
{
public:
	struct FNameCurve                                  Events;                                                   // 0x00E0(0x0078) (Deprecated)
	struct FMovieSceneEventSectionData                 eventData;                                                // 0x0158(0x0088)
...
{
public:
	unsigned char                                      bFireEventsWhenForwards : 1;                              // 0x0058(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bFireEventsWhenBackwards : 1;                             // 0x0058(0x0001) (Edit BITFIELD: 0202)
...
public:
	...
	unsigned char                                      bFadeAudio : 1;                                           // 0x0190(0x0001) (Edit BITFIELD: 0101)
...
{
public:
	struct FMovieSceneObjectPathChannel                ObjectChannel;                                            // 0x00E0(0x00C0)
...
public:
	...
	TArray<struct FTransformParameterNameAndCurves>    TransformParameterNamesAndCurves;                         // 0x0110(0x0010) (ZeroConstructor)
...
{
public:
	struct FMovieSceneObjectPathChannel                MaterialChannel;                                          // 0x00E0(0x00C0)
...
{
public:
	struct FMovieSceneSkeletalAnimationParams          Params;                                                   // 0x00E0(0x00D8) (Edit, BlueprintVisible)
	class UAnimSequence*                               AnimSequence;                                             // 0x01B8(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	class UAnimSequenceBase*                           Animation;                                                // 0x01C0(0x0008) (ZeroConstructor, Deprecated, IsPlainOldData)
	...
	unsigned char                                      bReverse : 1;                                             // 0x01D4(0x0001) (Deprecated BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bUseLegacySectionIndexBlend;                              // 0x0068(0x0001) (ZeroConstructor, IsPlainOldData)
