...
public:
	...
	void STATIC_BndEvt__Resume_K2Node_ComponentBoundEvent_81_OnClicked__DelegateSignature();
	void STATIC_BndEvt__Quit_K2Node_ComponentBoundEvent_86_OnClicked__DelegateSignature();
	void STATIC_BndEvt__Menu_K2Node_ComponentBoundEvent_93_OnClicked__DelegateSignature();
	void STATIC_BndEvt__Options_K2Node_ComponentBoundEvent_103_OnClicked__DelegateSignature();
	void STATIC_Remove();
	void STATIC_OnESC();
	void STATIC_Construct();
	void STATIC_OnResume();
	void STATIC_BndEvt__Hack_K2Node_ComponentBoundEvent_28_OnButtonClickedEvent__DelegateSignature();
	void STATIC_BndEvt__UI_MenuButton_C_1_K2Node_ComponentBoundEvent_31_OnClicked__DelegateSignature();
	void STATIC_BndEvt__AddToFavorites_K2Node_ComponentBoundEvent_10_OnClicked__DelegateSignature();
	void STATIC_OnQuitCanceled();
	void STATIC_OnQuit();
	void STATIC_OnLeaveToMainMenu();
	void STATIC_OnLeaveToMainMenuCanceled();
	void STATIC_OnSuicideCanceled();
	void STATIC_OnSuicideConfirmed();
	void STATIC_BndEvt__Statistics_K2Node_ComponentBoundEvent_0_OnClicked__DelegateSignature();
