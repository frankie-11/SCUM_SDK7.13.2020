...
public:
	...
	unsigned char                                      bUseAvoidance;                                            // 0x0170(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bRecreateRequired;                                        // 0x01D4(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	...
	unsigned char                                      bWasAvoidanceUpdated;                                     // 0x0208(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      bAutoReverse;                                             // 0x0320(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              WrongDirectionThreshold;                                  // 0x0324(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAutoBrake;                                               // 0x0328(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bGearUp;                                                  // 0x0044(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bGearDown;                                                // 0x0045(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
...
{
public:
	unsigned char                                      bUseRawInput;                                             // 0x0240(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
