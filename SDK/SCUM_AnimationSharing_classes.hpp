...
public:
	...
	unsigned char                                      bStateBool;                                               // 0x0278(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
	class UAnimSharingInstance*                        Instance;                                                 // 0x0280(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	unsigned char                                      bBlendBool;                                               // 0x027C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      bStateBool;                                               // 0x027C(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, Transient, DisableEditOnInstance, IsPlainOldData)
