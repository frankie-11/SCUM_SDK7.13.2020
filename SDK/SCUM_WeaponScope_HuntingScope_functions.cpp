...
void AWeaponScope_HuntingScope_C::SetZoomLevelOnServer(int* zoomLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetZoomLevelOnServer");

	AWeaponScope_HuntingScope_C_SetZoomLevelOnServer_Params params;
...
void AWeaponScope_HuntingScope_C::SetWindageOnServer(int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetWindageOnServer");

	AWeaponScope_HuntingScope_C_SetWindageOnServer_Params params;
...
void AWeaponScope_HuntingScope_C::SetLoadedVariablesOnClient(int* zoomLevel, int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetLoadedVariablesOnClient");

	AWeaponScope_HuntingScope_C_SetLoadedVariablesOnClient_Params params;
	params.zoomLevel = zoomLevel;
	params.Windage = Windage;
