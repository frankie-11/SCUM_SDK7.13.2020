...
void AZombie_WorkPants_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_WorkPants_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_WorkPants_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_WorkPants_C_SetDirtiness_Params params;
...
void AZombie_WorkPants_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_WorkPants_C_OnRep_MaterialParameters_Params params;
...
int AZombie_WorkPants_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_WorkPants_C_GetCapacityY_Params params;
...
int AZombie_WorkPants_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_WorkPants_C_GetCapacityX_Params params;
