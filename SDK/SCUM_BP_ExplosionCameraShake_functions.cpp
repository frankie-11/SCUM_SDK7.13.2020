...
void UBP_ExplosionCameraShake_C::ReceiveStopShake(bool* bImmediately)
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.ReceiveStopShake");

	UBP_ExplosionCameraShake_C_ReceiveStopShake_Params params;
...
void UBP_ExplosionCameraShake_C::ReceivePlayShake(float* Scale)
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.ReceivePlayShake");

	UBP_ExplosionCameraShake_C_ReceivePlayShake_Params params;
	params.Scale = Scale;
...
bool UBP_ExplosionCameraShake_C::ReceiveIsFinished()
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.ReceiveIsFinished");

	UBP_ExplosionCameraShake_C_ReceiveIsFinished_Params params;
...
void UBP_ExplosionCameraShake_C::BlueprintUpdateCameraShake(float* DeltaTime, float* Alpha, struct FMinimalViewInfo* POV, struct FMinimalViewInfo* ModifiedPOV)
{
	static auto fn = UObject::FindObject<UFunction>("Function Engine.CameraShake.BlueprintUpdateCameraShake");

	UBP_ExplosionCameraShake_C_BlueprintUpdateCameraShake_Params params;
