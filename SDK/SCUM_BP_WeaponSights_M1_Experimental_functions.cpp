...
void ABP_WeaponSights_M1_Experimental_C::OnAttachedToItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WeaponSightBase.BP_WeaponSightBase_C.OnAttachedToItem");

	ABP_WeaponSights_M1_Experimental_C_OnAttachedToItem_Params params;
	params.Item = Item;
...
void ABP_WeaponSights_M1_Experimental_C::STATIC_OnDetachedFromItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_WeaponSightBase.BP_WeaponSightBase_C.OnDetachedFromItem");

	ABP_WeaponSights_M1_Experimental_C_OnDetachedFromItem_Params params;
	params.Item = Item;
...
void ABP_WeaponSights_M1_Experimental_C::STATIC_ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
	...
	ABP_WeaponSights_M1_Experimental_C_ExecuteUbergraph_BP_WeaponSightBase_Params params;
