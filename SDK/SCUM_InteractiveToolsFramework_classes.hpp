...
public:
	...
	unsigned char                                      bViewAligned;                                             // 0x0410(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bOnlyAllowFrontFacingHits;                                // 0x0411(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0xE];                                       // 0x0412(0x000E) MISSED OFFSET
