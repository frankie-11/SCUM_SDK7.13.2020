...
void ABP_WeaponScope_M82A1_Snow_C::SetZoomLevelOnServer(int* zoomLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetZoomLevelOnServer");

	ABP_WeaponScope_M82A1_Snow_C_SetZoomLevelOnServer_Params params;
...
void ABP_WeaponScope_M82A1_Snow_C::SetWindageOnServer(int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetWindageOnServer");

	ABP_WeaponScope_M82A1_Snow_C_SetWindageOnServer_Params params;
...
void ABP_WeaponScope_M82A1_Snow_C::SetLoadedVariablesOnClient(int* zoomLevel, int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetLoadedVariablesOnClient");

	ABP_WeaponScope_M82A1_Snow_C_SetLoadedVariablesOnClient_Params params;
	params.zoomLevel = zoomLevel;
	params.Windage = Windage;
