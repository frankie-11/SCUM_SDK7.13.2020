...
bool ABP_M9_Silver_C::CanSwitchFiringMode()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_M9.BP_M9_C.CanSwitchFiringMode");

	ABP_M9_Silver_C_CanSwitchFiringMode_Params params;
...
void ABP_M9_Silver_C::ReceiveBeginPlay()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_M9.BP_M9_C.ReceiveBeginPlay");

	ABP_M9_Silver_C_ReceiveBeginPlay_Params params;
...
void ABP_M9_Silver_C::ExecuteUbergraph_BP_M9(int* EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_M9.BP_M9_C.ExecuteUbergraph_BP_M9");

	ABP_M9_Silver_C_ExecuteUbergraph_BP_M9_Params params;
