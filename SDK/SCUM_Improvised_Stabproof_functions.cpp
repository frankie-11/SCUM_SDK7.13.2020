...
void AImprovised_Stabproof_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AImprovised_Stabproof_C_UpdateMaterialParamsOnClients_Params params;
...
void AImprovised_Stabproof_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AImprovised_Stabproof_C_SetDirtiness_Params params;
...
void AImprovised_Stabproof_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AImprovised_Stabproof_C_OnRep_MaterialParameters_Params params;
...
int AImprovised_Stabproof_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AImprovised_Stabproof_C_GetWarmth_Params params;
...
int AImprovised_Stabproof_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AImprovised_Stabproof_C_GetCapacityY_Params params;
...
int AImprovised_Stabproof_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AImprovised_Stabproof_C_GetCapacityX_Params params;
