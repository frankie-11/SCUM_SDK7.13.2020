...
void ARaincoat_Down_05_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ARaincoat_Down_05_C_UpdateMaterialParamsOnClients_Params params;
...
void ARaincoat_Down_05_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ARaincoat_Down_05_C_SetDirtiness_Params params;
...
void ARaincoat_Down_05_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ARaincoat_Down_05_C_OnRep_MaterialParameters_Params params;
...
int ARaincoat_Down_05_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ARaincoat_Down_05_C_GetCapacityY_Params params;
...
int ARaincoat_Down_05_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ARaincoat_Down_05_C_GetCapacityX_Params params;
