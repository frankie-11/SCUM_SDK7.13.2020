...
bool ARare_02_C::Use(class APrisoner** Prisoner, int* usage, float* usageWeight, bool* Eat, float* damageMultiplier)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Use");

	ARare_02_C_Use_Params params;
...
void ARare_02_C::UpdateVisuals(bool* shouldHandleAging)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.UpdateVisuals");

	ARare_02_C_UpdateVisuals_Params params;
...
void ARare_02_C::StaticMeshChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.StaticMeshChangedDelegate__DelegateSignature");

	ARare_02_C_StaticMeshChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void ARare_02_C::SkeletalMeshChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.SkeletalMeshChangedDelegate__DelegateSignature");

	ARare_02_C_SkeletalMeshChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void ARare_02_C::SetMaxHealth(float* maxHealth)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetMaxHealth");

	ARare_02_C_SetMaxHealth_Params params;
...
void ARare_02_C::SetHealthAndUsage(float* health, int* usage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetHealthAndUsage");

	ARare_02_C_SetHealthAndUsage_Params params;
...
void ARare_02_C::SetHealth(float* health)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetHealth");

	ARare_02_C_SetHealth_Params params;
	params.health = health;
...
void ARare_02_C::Server_Throw(struct FVector* ZeroBasedStartPosition, struct FRotator* StartRotation, struct FVector* StartVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Server_Throw");

	ARare_02_C_Server_Throw_Params params;
...
void ARare_02_C::Repair(float* healthToRepair)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Repair");

	ARare_02_C_Repair_Params params;
...
TScriptInterface<class UInventoryNode> ARare_02_C::RemoveStacks(int* stacksToSplit)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.RemoveStacks");

	ARare_02_C_RemoveStacks_Params params;
...
void ARare_02_C::PickedUpStateDelegate__DelegateSignature(class AItem** Item, bool* pickedUp)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.PickedUpStateDelegate__DelegateSignature");

	ARare_02_C_PickedUpStateDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void ARare_02_C::OnRep_InventoryContainer2D()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnRep_InventoryContainer2D");

	ARare_02_C_OnRep_InventoryContainer2D_Params params;
...
void ARare_02_C::OnProjectileStop(struct FHitResult* ImpactResult)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnProjectileStop");

	ARare_02_C_OnProjectileStop_Params params;
...
void ARare_02_C::OnLocalPrisonerPanelsClosed()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnLocalPrisonerPanelsClosed");

	ARare_02_C_OnLocalPrisonerPanelsClosed_Params params;
...
void ARare_02_C::OnLocalPrisonerHoveredActorChanged(class AActor** hoveredActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnLocalPrisonerHoveredActorChanged");

	ARare_02_C_OnLocalPrisonerHoveredActorChanged_Params params;
...
void ARare_02_C::OnEditTextWidgetTextAccepted(class APrisoner** User, struct FText* Text)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnEditTextWidgetTextAccepted");

	ARare_02_C_OnEditTextWidgetTextAccepted_Params params;
	params.User = User;
	params.Text = Text;
...
void ARare_02_C::OnDetachedFromItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnDetachedFromItem");

	ARare_02_C_OnDetachedFromItem_Params params;
	params.Item = Item;
...
void ARare_02_C::OnDestroyedEvent(class AActor** Self)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnDestroyedEvent");

	ARare_02_C_OnDestroyedEvent_Params params;
	params.Self = Self;
...
void ARare_02_C::OnContainedItemDestroyed(class AActor** containedItem)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnContainedItemDestroyed");

	ARare_02_C_OnContainedItemDestroyed_Params params;
...
void ARare_02_C::OnAttachedToItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnAttachedToItem");

	ARare_02_C_OnAttachedToItem_Params params;
	params.Item = Item;
...
void ARare_02_C::NetMulticast_SpawnDestroyedEffects()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SpawnDestroyedEffects");

	ARare_02_C_NetMulticast_SpawnDestroyedEffects_Params params;
...
void ARare_02_C::NetMulticast_SetPlayerGivenName(struct FString* Value)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SetPlayerGivenName");

	ARare_02_C_NetMulticast_SetPlayerGivenName_Params params;
	params.Value = Value;
...
void ARare_02_C::NetMulticast_SetActorDropLocationAndRotation(struct FVector* Location, struct FRotator* Rotation)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SetActorDropLocationAndRotation");

	ARare_02_C_NetMulticast_SetActorDropLocationAndRotation_Params params;
...
void ARare_02_C::Multicast_UpdateExpirationTime(int64_t* Time)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Multicast_UpdateExpirationTime");

	ARare_02_C_Multicast_UpdateExpirationTime_Params params;
	params.Time = Time;
...
void ARare_02_C::Multicast_Throw(struct FVector* ZeroBasedStartPosition, struct FRotator* StartRotation, struct FVector* StartVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Multicast_Throw");

	ARare_02_C_Multicast_Throw_Params params;
	params.ZeroBasedStartPosition = ZeroBasedStartPosition;
	params.StartRotation = StartRotation;
	params.StartVelocity = StartVelocity;
...
bool ARare_02_C::HasPriorityForContainerItem(class AItem** containerItem)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.HasPriorityForContainerItem");

	ARare_02_C_HasPriorityForContainerItem_Params params;
...
struct FWidgetDisplayInfo ARare_02_C::GetWidgetDisplayInfo()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetWidgetDisplayInfo");

	ARare_02_C_GetWidgetDisplayInfo_Params params;
...
float ARare_02_C::GetNoiseLoudnessWhenPickedUp()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessWhenPickedUp");

	ARare_02_C_GetNoiseLoudnessWhenPickedUp_Params params;
...
float ARare_02_C::GetNoiseLoudnessWhenDropped()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessWhenDropped");

	ARare_02_C_GetNoiseLoudnessWhenDropped_Params params;
...
float ARare_02_C::GetNoiseLoudnessOnGroundImpact()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessOnGroundImpact");

	ARare_02_C_GetNoiseLoudnessOnGroundImpact_Params params;
...
class UMeshComponent* ARare_02_C::GetMeshComponent()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetMeshComponent");

	ARare_02_C_GetMeshComponent_Params params;
...
float ARare_02_C::GetContainerDamagePercentage()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetContainerDamagePercentage");

	ARare_02_C_GetContainerDamagePercentage_Params params;
...
TArray<class AItem*> ARare_02_C::GetAllContainedItems(bool* recursive)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetAllContainedItems");

	ARare_02_C_GetAllContainedItems_Params params;
...
bool ARare_02_C::DropAt(struct FVector* dropLocation, struct FRotator* dropRotation)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.DropAt");

	ARare_02_C_DropAt_Params params;
...
bool ARare_02_C::DropAround(class AActor** Actor, float* Radius)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.DropAround");

	ARare_02_C_DropAround_Params params;
	params.Actor = Actor;
...
void ARare_02_C::DebugTextChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.DebugTextChangedDelegate__DelegateSignature");

	ARare_02_C_DebugTextChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
bool ARare_02_C::CanStackWith(class UObject** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanStackWith");

	ARare_02_C_CanStackWith_Params params;
	params.Item = Item;
...
bool ARare_02_C::CanBeDroppedBy(class AConZCharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanBeDroppedBy");

	ARare_02_C_CanBeDroppedBy_Params params;
...
bool ARare_02_C::CanBeCraftedByCharactrer(class ACharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanBeCraftedByCharactrer");

	ARare_02_C_CanBeCraftedByCharactrer_Params params;
	params.Character = Character;
...
bool ARare_02_C::CanAutoAddItem(class AItem** Item, unsigned char* column, unsigned char* row)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanAutoAddItem");

	ARare_02_C_CanAutoAddItem_Params params;
	params.Item = Item;
...
bool ARare_02_C::CanAddItem(class AItem** Item, unsigned char* column, unsigned char* row)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanAddItem");

	ARare_02_C_CanAddItem_Params params;
	params.Item = Item;
...
bool ARare_02_C::AutoAddItemToInventoryNode(TScriptInterface<class UInventoryNode>* Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AutoAddItemToInventoryNode");

	ARare_02_C_AutoAddItemToInventoryNode_Params params;
	params.Item = Item;
...
bool ARare_02_C::AttachToCharacterHands(class AConZCharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AttachToCharacterHands");

	ARare_02_C_AttachToCharacterHands_Params params;
	params.Character = Character;
...
void ARare_02_C::AddStack(TScriptInterface<class UInventoryNode>* Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AddStack");

	ARare_02_C_AddStack_Params params;
	params.Item = Item;
