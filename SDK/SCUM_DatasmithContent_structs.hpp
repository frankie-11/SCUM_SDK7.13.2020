...
{
	unsigned char                                      bEnableLookAtTracking : 1;                                // 0x0000(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bAllowRoll : 1;                                           // 0x0000(0x0001) ( BITFIELD: 0202)
	unsigned char                                      UnknownData00[0x28];                                      // 0x0001(0x0028) UNKNOWN PROPERTY: SoftObjectProperty DatasmithContent.DatasmithCameraLookatTrackingSettingsTemplate.ActorToTrack
};
...
{
	unsigned char                                      bOverride_WhiteTemp : 1;                                  // 0x0000(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bOverride_ColorSaturation : 1;                            // 0x0000(0x0001) ( BITFIELD: 0202)
	unsigned char                                      bOverride_VignetteIntensity : 1;                          // 0x0000(0x0001) ( BITFIELD: 0404)
	unsigned char                                      bOverride_FilmWhitePoint : 1;                             // 0x0000(0x0001) ( BITFIELD: 0808)
	unsigned char                                      bOverride_AutoExposureMethod : 1;                         // 0x0000(0x0001) ( BITFIELD: 1010)
	unsigned char                                      bOverride_CameraISO : 1;                                  // 0x0000(0x0001) ( BITFIELD: 2020)
	unsigned char                                      bOverride_CameraShutterSpeed : 1;                         // 0x0000(0x0001) ( BITFIELD: 4040)
	unsigned char                                      bOverride_DepthOfFieldFstop : 1;                          // 0x0004(0x0001) ( BITFIELD: 0101)
...
struct FDatasmithStaticMeshImportOptions
{
	...
	unsigned char                                      bGenerateLightmapUVs;                                     // 0x0002(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bRemoveDegenerates;                                       // 0x0003(0x0001) (BlueprintVisible, ZeroConstructor, Transient, IsPlainOldData)
};
...
struct FDatasmithImportBaseOptions
{
	...
	unsigned char                                      bIncludeGeometry;                                         // 0x0001(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bIncludeMaterial;                                         // 0x0002(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bIncludeLight;                                            // 0x0003(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bIncludeCamera;                                           // 0x0004(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bIncludeAnimation;                                        // 0x0005(0x0001) (Edit, BlueprintVisible, ZeroConstructor, Config, IsPlainOldData)
...
{
	unsigned char                                      bUpdateActors;                                            // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bRespawnDeletedActors;                                    // 0x0001(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
{
	TMap<struct FName, unsigned char>                  StaticSwitchParameters;                                   // 0x0000(0x0050) (ZeroConstructor)
};
...
{
	unsigned char                                      bUseMikkTSpace : 1;                                       // 0x0000(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bRecomputeNormals : 1;                                    // 0x0000(0x0001) ( BITFIELD: 0202)
	unsigned char                                      bRecomputeTangents : 1;                                   // 0x0000(0x0001) ( BITFIELD: 0404)
	unsigned char                                      bRemoveDegenerates : 1;                                   // 0x0000(0x0001) ( BITFIELD: 0808)
	unsigned char                                      bBuildAdjacencyBuffer : 1;                                // 0x0000(0x0001) ( BITFIELD: 1010)
	unsigned char                                      bUseHighPrecisionTangentBasis : 1;                        // 0x0000(0x0001) ( BITFIELD: 2020)
	unsigned char                                      bUseFullPrecisionUVs : 1;                                 // 0x0000(0x0001) ( BITFIELD: 4040)
	unsigned char                                      bGenerateLightmapUVs : 1;                                 // 0x0000(0x0001) ( BITFIELD: 8080)
