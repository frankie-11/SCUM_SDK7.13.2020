...
public:
	...
	unsigned char                                      _shouldFade;                                              // 0x0258(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void StartFade();
	void Init(struct FText* Text, TEnumAsByte<EMessageType>* Type, float* Duration, struct FLinearColor* Color);
