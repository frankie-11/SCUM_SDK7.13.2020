...
void ABirthday_Cap_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABirthday_Cap_C_UpdateMaterialParamsOnClients_Params params;
...
void ABirthday_Cap_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABirthday_Cap_C_SetDirtiness_Params params;
...
void ABirthday_Cap_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABirthday_Cap_C_OnRep_MaterialParameters_Params params;
