...
void AHiking_Backpack_07_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHiking_Backpack_07_C_UpdateMaterialParamsOnClients_Params params;
...
void AHiking_Backpack_07_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHiking_Backpack_07_C_SetDirtiness_Params params;
...
void AHiking_Backpack_07_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AHiking_Backpack_07_C_OnRep_MaterialParameters_Params params;
...
int AHiking_Backpack_07_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AHiking_Backpack_07_C_GetWarmth_Params params;
...
int AHiking_Backpack_07_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AHiking_Backpack_07_C_GetCapacityY_Params params;
...
int AHiking_Backpack_07_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AHiking_Backpack_07_C_GetCapacityX_Params params;
