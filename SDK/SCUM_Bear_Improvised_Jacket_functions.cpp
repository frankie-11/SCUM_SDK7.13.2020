...
void ABear_Improvised_Jacket_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABear_Improvised_Jacket_C_UpdateMaterialParamsOnClients_Params params;
...
void ABear_Improvised_Jacket_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABear_Improvised_Jacket_C_SetDirtiness_Params params;
...
void ABear_Improvised_Jacket_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABear_Improvised_Jacket_C_OnRep_MaterialParameters_Params params;
...
int ABear_Improvised_Jacket_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	ABear_Improvised_Jacket_C_GetWarmth_Params params;
...
int ABear_Improvised_Jacket_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ABear_Improvised_Jacket_C_GetCapacityY_Params params;
...
int ABear_Improvised_Jacket_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ABear_Improvised_Jacket_C_GetCapacityX_Params params;
