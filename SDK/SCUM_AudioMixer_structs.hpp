...
struct FSubmixEffectDynamicsProcessorSettings
{
	...
	unsigned char                                      bChannelLinked : 1;                                       // 0x0024(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bAnalogMode : 1;                                          // 0x0024(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
};
...
struct FSubmixEffectEQBand
{
	...
	unsigned char                                      bEnabled : 1;                                             // 0x000C(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
};
