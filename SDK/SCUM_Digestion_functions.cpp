...
// (NetRequest, Native, Event, NetResponse, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
...
// (Net, NetReliable, Static, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
...
void UDigestion_C::STATIC_PrintArrayOfDigestionItems(TArray<class UDigestionItem*>* digestionItemsTArray)
{
...
// (NetReliable, NetRequest, Event, NetResponse, NetMulticast, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
...
// (Net, Exec, Event, NetResponse, Static, Public, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
...
void UDigestion_C::STATIC_DigestionItemToText(class UDigestionItem** digestionItemRef, struct FText* digestionItemName, struct FText* digestionItemID, struct FText* digestionItemWeight)
{
...
// (Event, NetResponse, NetMulticast, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
...
// (Net, NetRequest, Native, Event, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
// class UDigestionItem**         digestionItemRef               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
...
// (Net, NetReliable, NetRequest, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// ESlateVisibility*              Visibility                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UDigestion_C::STATIC_ShowDigestion(ESlateVisibility* Visibility)
{
...
void UDigestion_C::STATIC_InitDigestionItems()
{
...
// (Net, Exec, Native, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
// int*                           Index                          (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
// class UParameterLine_C**       digestionLineRef               (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, InstancedReference, IsPlainOldData)

void UDigestion_C::STATIC_AddDigestionLine(int* Index, class UParameterLine_C** digestionLineRef)
{
...
// (Net, NetReliable, NetRequest, Exec, Static, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
// Parameters:
...
void UDigestion_C::STATIC_CreateDigestionLineFromText(struct FText* digestionItemName, struct FText* digestionItemID, struct FText* digestionItemWeightRemained, class UParameterLine_C** digestionLine)
{
...
// (NetReliable, NetRequest, Native, Event, Static, Public, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// TArray<class UDigestionItem*>  digestionItemsTArrayRef        (Parm, OutParm, ZeroConstructor)

void UDigestion_C::STATIC_GetDigestionItems(TArray<class UDigestionItem*>* digestionItemsTArrayRef)
{
...
void UDigestion_C::STATIC_SetDigestionCount(int* digestionItemsCountToSet)
{
...
// (Net, NetRequest, Exec, Native, Event, NetResponse, MulticastDelegate, Private, Protected, HasOutParms, HasDefaults, DLLImport, BlueprintEvent)
...
// (Net, Native, NetResponse, Static, Public, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// int                            numberOfDigestionItems         (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UDigestion_C::STATIC_CountDigestionItems(int* numberOfDigestionItems)
{
...
// (NetReliable, Exec, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool                           sicknessCountChanged           (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UDigestion_C::STATIC_HasDigestionCountChanged(bool* sicknessCountChanged)
{
...
// (NetReliable, NetRequest, Native, Event, NetResponse, Static, MulticastDelegate, Private, Delegate, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)

void UDigestion_C::STATIC_UpdateDigestion()
{
...
// (NetRequest, Exec, Native, Event, Static, Public, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FText                   ReturnValue                    (Parm, OutParm, ReturnParm)

struct FText UDigestion_C::STATIC_GetTitleText()
{
...
// (Net, Exec, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FText                   defaultTitle                   (Parm, OutParm)

void UDigestion_C::STATIC_GetDefaultTitle(struct FText* defaultTitle)
{
...
// (Net, NetReliable, NetRequest, Exec, Native, Event, Static, Public, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintCallable, BlueprintEvent, BlueprintPure)
// Parameters:
// struct FLinearColor            Color                          (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UDigestion_C::STATIC_SelectCustomColor(struct FLinearColor* Color)
{
...
void UDigestion_C::STATIC_Construct()
{
...
// (Exec, Event, NetResponse, Static, NetMulticast, MulticastDelegate, Public, Private, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)
// Parameters:
// bool*                          shouldMinimize                 (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UDigestion_C::STATIC_OnMinimize(bool* shouldMinimize)
{
...
// (Native, Static, MulticastDelegate, Public, Delegate, HasDefaults, NetClient, BlueprintCallable, BlueprintEvent)

void UDigestion_C::STATIC_OnPrisonerSet()
{
...
void UDigestion_C::STATIC_UpdateContent()
{
...
// (Net, Native, Protected, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, DLLImport, BlueprintEvent, BlueprintPure, Const, NetValidate)
// Parameters:
