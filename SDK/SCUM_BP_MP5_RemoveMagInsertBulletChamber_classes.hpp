...
// BlueprintGeneratedClass BP_MP5_RemoveMagInsertBulletChamber.BP_MP5_RemoveMagInsertBulletChamber_C
// 0x0000 (0x0088 - 0x0088)
class UBP_MP5_RemoveMagInsertBulletChamber_C : public URemoveMagazineInsertCartridge
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MP5_RemoveMagInsertBulletChamber.BP_MP5_RemoveMagInsertBulletChamber_C");
		return ptr;
	}
