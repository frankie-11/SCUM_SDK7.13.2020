...
// BlueprintGeneratedClass BP_AS_Val_Reload_Event.BP_AS_Val_Reload_Event_C
// 0x0000 (0x0088 - 0x0088)
class UBP_AS_Val_Reload_Event_C : public UEventInsertMagazine
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_AS_Val_Reload_Event.BP_AS_Val_Reload_Event_C");
		return ptr;
	}
