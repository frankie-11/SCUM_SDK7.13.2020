...
void AZombie_Woodcutter_Shirt_03_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Woodcutter_Shirt_03_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Woodcutter_Shirt_03_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Woodcutter_Shirt_03_C_SetDirtiness_Params params;
...
void AZombie_Woodcutter_Shirt_03_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Woodcutter_Shirt_03_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Woodcutter_Shirt_03_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Woodcutter_Shirt_03_C_GetWarmth_Params params;
...
int AZombie_Woodcutter_Shirt_03_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Woodcutter_Shirt_03_C_GetCapacityY_Params params;
...
int AZombie_Woodcutter_Shirt_03_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Woodcutter_Shirt_03_C_GetCapacityX_Params params;
