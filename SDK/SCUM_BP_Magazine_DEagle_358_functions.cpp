...
void ABP_Magazine_DEagle_357_C::SetAmmoCount(int* Amount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.SetAmmoCount");

	ABP_Magazine_DEagle_357_C_SetAmmoCount_Params params;
...
void ABP_Magazine_DEagle_357_C::Server_InsertCartridgeIntoMagazine(class AAmmunitionItem** ammo)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Server_InsertCartridgeIntoMagazine");

	ABP_Magazine_DEagle_357_C_Server_InsertCartridgeIntoMagazine_Params params;
	params.ammo = ammo;
...
void ABP_Magazine_DEagle_357_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnRep_AmmoCountOwnerHelper");

	ABP_Magazine_DEagle_357_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ABP_Magazine_DEagle_357_C::OnRep_AmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnRep_AmmoCount");

	ABP_Magazine_DEagle_357_C_OnRep_AmmoCount_Params params;
...
void ABP_Magazine_DEagle_357_C::OnAmmoChangedEvent()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnAmmoChangedEvent");

	ABP_Magazine_DEagle_357_C_OnAmmoChangedEvent_Params params;
...
void ABP_Magazine_DEagle_357_C::Multicast_SetLoadedVariables(int* ammoCount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Multicast_SetLoadedVariables");

	ABP_Magazine_DEagle_357_C_Multicast_SetLoadedVariables_Params params;
...
class UClass* ABP_Magazine_DEagle_357_C::GetProjectileClass()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.GetProjectileClass");

	ABP_Magazine_DEagle_357_C_GetProjectileClass_Params params;
...
void ABP_Magazine_DEagle_357_C::AddAmmo(int* Amount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.AddAmmo");

	ABP_Magazine_DEagle_357_C_AddAmmo_Params params;
	params.Amount = Amount;
