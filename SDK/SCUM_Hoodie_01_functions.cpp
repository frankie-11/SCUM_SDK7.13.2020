...
void AHoodie_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHoodie_01_C_UpdateMaterialParamsOnClients_Params params;
...
void AHoodie_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHoodie_01_C_SetDirtiness_Params params;
