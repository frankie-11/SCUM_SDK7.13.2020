...
void ABP_FlareItem_Blue_C::SwitchPointLight(bool* turnOn)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.SwitchPointLight");

	ABP_FlareItem_Blue_C_SwitchPointLight_Params params;
...
void ABP_FlareItem_Blue_C::SetState(EFlareIgniteState* State)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.SetState");

	ABP_FlareItem_Blue_C_SetState_Params params;
	params.State = State;
...
void ABP_FlareItem_Blue_C::RequestPrisonerIgniteFlare(class APrisoner** Prisoner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.RequestPrisonerIgniteFlare");

	ABP_FlareItem_Blue_C_RequestPrisonerIgniteFlare_Params params;
...
void ABP_FlareItem_Blue_C::OnRep_State()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.OnRep_State");

	ABP_FlareItem_Blue_C_OnRep_State_Params params;
...
bool ABP_FlareItem_Blue_C::IsBurning()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.IsBurning");

	ABP_FlareItem_Blue_C_IsBurning_Params params;
...
void ABP_FlareItem_Blue_C::Ignite(class APrisoner** Prisoner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.Ignite");

	ABP_FlareItem_Blue_C_Ignite_Params params;
	params.Prisoner = Prisoner;
...
EFlareIgniteState ABP_FlareItem_Blue_C::GetState()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.GetState");

	ABP_FlareItem_Blue_C_GetState_Params params;
