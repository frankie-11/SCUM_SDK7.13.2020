...
void AMilitaryPants_07_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitaryPants_07_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitaryPants_07_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitaryPants_07_C_SetDirtiness_Params params;
...
void AMilitaryPants_07_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitaryPants_07_C_OnRep_MaterialParameters_Params params;
...
int AMilitaryPants_07_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AMilitaryPants_07_C_GetCapacityY_Params params;
...
int AMilitaryPants_07_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AMilitaryPants_07_C_GetCapacityX_Params params;
