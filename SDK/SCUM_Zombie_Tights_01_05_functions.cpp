...
void AZombie_Tights_01_05_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Tights_01_05_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Tights_01_05_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Tights_01_05_C_SetDirtiness_Params params;
...
void AZombie_Tights_01_05_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Tights_01_05_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Tights_01_05_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Tights_01_05_C_GetWarmth_Params params;
...
int AZombie_Tights_01_05_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Tights_01_05_C_GetCapacityY_Params params;
...
int AZombie_Tights_01_05_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Tights_01_05_C_GetCapacityX_Params params;
