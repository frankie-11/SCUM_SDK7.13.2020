...
public:
	...
	unsigned char                                      bRecalcPathOnDestinationChanged : 1;                      // 0x00EC(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	...
	unsigned char                                      bTeleportToDestinationUponFailure;                        // 0x0130(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MaxTimeBeforeTeleport;                                    // 0x0134(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x50];                                      // 0x0138(0x0050) MISSED OFFSET
...
{
public:
	unsigned char                                      bSearchRandomLocation : 1;                                // 0x01C0(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bIsUnbound;                                               // 0x040C(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      PerformCollisionChecksOnStartup;                          // 0x0474(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bMultiThreadingEnabled;                                   // 0x0475(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bDisplayWorldBoundary;                                    // 0x04A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDisplayWorldBoundaryInGame;                              // 0x04A1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              DebugVoxelsLineThickness;                                 // 0x04A4(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bRunDebugValidationsForDynamicCollisions;                 // 0x04A8(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x653F];                                    // 0x04A9(0x653F) MISSED OFFSET
	unsigned char                                      UnknownData03[0x50];                                      // 0x04A9(0x0050) UNKNOWN PROPERTY: SetProperty DonAINavigation.DonNavigationManager.ActiveNavigationTaskOwners
	unsigned char                                      UnknownData04[0x50];                                      // 0x6A38(0x0050) UNKNOWN PROPERTY: SetProperty DonAINavigation.DonNavigationManager.ActiveCollisionTaskOwners
	unsigned char                                      UnknownData05[0xE8];                                      // 0x6A88(0x00E8) MISSED OFFSET
