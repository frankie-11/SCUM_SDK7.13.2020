...
public:
	...
	struct FText                                       _parameterName;                                           // 0x0310(0x0018) (Edit, BlueprintVisible)
	struct FText                                       _RDAText;                                                 // 0x0328(0x0018) (Edit, BlueprintVisible)
	...
	struct FText                                       _measurementUnit;                                         // 0x0368(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       _percentageText;                                          // 0x0380(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       _currentValueText;                                        // 0x0398(0x0018) (Edit, BlueprintVisible)
