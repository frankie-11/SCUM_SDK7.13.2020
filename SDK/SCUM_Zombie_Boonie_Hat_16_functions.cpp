...
void AZombie_Boonie_Hat_15_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Boonie_Hat_15_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Boonie_Hat_15_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Boonie_Hat_15_C_SetDirtiness_Params params;
...
void AZombie_Boonie_Hat_15_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Boonie_Hat_15_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Boonie_Hat_15_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Boonie_Hat_15_C_GetWarmth_Params params;
...
int AZombie_Boonie_Hat_15_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Boonie_Hat_15_C_GetCapacityY_Params params;
...
int AZombie_Boonie_Hat_15_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Boonie_Hat_15_C_GetCapacityX_Params params;
