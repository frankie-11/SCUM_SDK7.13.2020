...
void ACal_5_56x45_Bullet_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	ACal_5_56x45_Bullet_C_SetAmmoCount_Params params;
	params.count = count;
...
void ACal_5_56x45_Bullet_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCountOwnerHelper");

	ACal_5_56x45_Bullet_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ACal_5_56x45_Bullet_C::OnRep_AmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCount");

	ACal_5_56x45_Bullet_C_OnRep_AmmoCount_Params params;
...
int ACal_5_56x45_Bullet_C::GetAmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.GetAmmoCount");

	ACal_5_56x45_Bullet_C_GetAmmoCount_Params params;
...
void ACal_5_56x45_Bullet_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	ACal_5_56x45_Bullet_C_Client_SetAmmoCount_Params params;
	params.count = count;
