...
void AShemagh_Scarf_04_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AShemagh_Scarf_04_C_UpdateMaterialParamsOnClients_Params params;
...
void AShemagh_Scarf_04_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AShemagh_Scarf_04_C_SetDirtiness_Params params;
...
void AShemagh_Scarf_04_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AShemagh_Scarf_04_C_OnRep_MaterialParameters_Params params;
...
int AShemagh_Scarf_04_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AShemagh_Scarf_04_C_GetCapacityY_Params params;
...
int AShemagh_Scarf_04_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AShemagh_Scarf_04_C_GetCapacityX_Params params;
