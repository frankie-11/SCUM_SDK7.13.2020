...
void ABear_Pow_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABear_Pow_C_UpdateMaterialParamsOnClients_Params params;
...
void ABear_Pow_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABear_Pow_C_SetDirtiness_Params params;
