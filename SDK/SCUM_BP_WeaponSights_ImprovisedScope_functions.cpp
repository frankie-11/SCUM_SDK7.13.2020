...
void ABP_WeaponSights_ImprovisedScope_C::SetZoomLevelOnServer(int* zoomLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetZoomLevelOnServer");

	ABP_WeaponSights_ImprovisedScope_C_SetZoomLevelOnServer_Params params;
...
void ABP_WeaponSights_ImprovisedScope_C::SetWindageOnServer(int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetWindageOnServer");

	ABP_WeaponSights_ImprovisedScope_C_SetWindageOnServer_Params params;
...
void ABP_WeaponSights_ImprovisedScope_C::SetLoadedVariablesOnClient(int* zoomLevel, int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetLoadedVariablesOnClient");

	ABP_WeaponSights_ImprovisedScope_C_SetLoadedVariablesOnClient_Params params;
	params.zoomLevel = zoomLevel;
	params.Windage = Windage;
