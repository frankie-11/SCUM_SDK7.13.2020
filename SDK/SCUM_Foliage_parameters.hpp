...
struct AInstancedFoliageActor_SetNetDormancy_Params
{
...
struct AInstancedFoliageActor_PrestreamTextures_Params
{
...
struct AInstancedFoliageActor_K2_GetComponentsByClass_Params
{
...
struct AInstancedFoliageActor_GetLocalRole_Params
{
	TEnumAsByte<ENetRole>                              ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
...
struct AInstancedFoliageActor_GetComponentsByInterface_Params
{
...
struct UInteractiveFoliageComponent_SetReverseCulling_Params
{
...
struct UInteractiveFoliageComponent_SetDistanceFieldSelfShadowBias_Params
{
