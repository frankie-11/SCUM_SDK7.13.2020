...
// BlueprintGeneratedClass Improvised_Metal_Arrow.Improvised_Metal_Arrow_C
// 0x0000 (0x0670 - 0x0670)
class AImprovised_Metal_Arrow_C : public AItem
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Improvised_Metal_Arrow.Improvised_Metal_Arrow_C");
		return ptr;
	}
