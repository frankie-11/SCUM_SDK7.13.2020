...
class ASalted_fish_Barrel_01_C : public AFoodItem
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Salted_fish_Barrel_01.Salted_fish_Barrel_01_C");
		return ptr;
	}
