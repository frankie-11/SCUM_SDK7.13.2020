...
void ACamo_Backpack_03_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ACamo_Backpack_03_C_UpdateMaterialParamsOnClients_Params params;
...
void ACamo_Backpack_03_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ACamo_Backpack_03_C_SetDirtiness_Params params;
...
void ACamo_Backpack_03_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ACamo_Backpack_03_C_OnRep_MaterialParameters_Params params;
...
int ACamo_Backpack_03_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ACamo_Backpack_03_C_GetCapacityY_Params params;
...
int ACamo_Backpack_03_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ACamo_Backpack_03_C_GetCapacityX_Params params;
