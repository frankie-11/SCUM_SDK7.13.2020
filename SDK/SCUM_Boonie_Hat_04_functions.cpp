...
void ABoonie_Hat_04_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABoonie_Hat_04_C_UpdateMaterialParamsOnClients_Params params;
...
void ABoonie_Hat_04_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABoonie_Hat_04_C_SetDirtiness_Params params;
...
void ABoonie_Hat_04_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABoonie_Hat_04_C_OnRep_MaterialParameters_Params params;
