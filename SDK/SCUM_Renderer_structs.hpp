...
{
	unsigned char                                      bOverride_LPVIntensity : 1;                               // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bOverride_LPVDirectionalOcclusionIntensity : 1;           // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      bOverride_LPVDirectionalOcclusionRadius : 1;              // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      bOverride_LPVDiffuseOcclusionExponent : 1;                // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      bOverride_LPVSpecularOcclusionExponent : 1;               // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
	unsigned char                                      bOverride_LPVDiffuseOcclusionIntensity : 1;               // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 2020)
	unsigned char                                      bOverride_LPVSpecularOcclusionIntensity : 1;              // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 4040)
	unsigned char                                      bOverride_LPVSize : 1;                                    // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 8080)
	unsigned char                                      bOverride_LPVSecondaryOcclusionIntensity : 1;             // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bOverride_LPVSecondaryBounceIntensity : 1;                // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      bOverride_LPVGeometryVolumeBias : 1;                      // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      bOverride_LPVVplInjectionBias : 1;                        // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      bOverride_LPVEmissiveInjectionIntensity : 1;              // 0x0001(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
