...
void AZombie_Inmate_shirt_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Inmate_shirt_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Inmate_shirt_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Inmate_shirt_C_SetDirtiness_Params params;
...
void AZombie_Inmate_shirt_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Inmate_shirt_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Inmate_shirt_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Inmate_shirt_C_GetWarmth_Params params;
...
int AZombie_Inmate_shirt_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Inmate_shirt_C_GetCapacityY_Params params;
...
int AZombie_Inmate_shirt_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Inmate_shirt_C_GetCapacityX_Params params;
