...
public:
	...
	unsigned char                                      UnknownData00[0xF];                                       // 0x03C4(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      UnknownData02[0x50];                                      // 0x0D90(0x0050) MISSED OFFSET
...
public:
	...
	unsigned char                                      bManuallyRedraw;                                          // 0x0418(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bRedrawRequested;                                         // 0x0419(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bDrawAtDesiredSize;                                       // 0x0430(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FVector2D                                   Pivot;                                                    // 0x0434(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bReceiveHardwareInput;                                    // 0x043C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bWindowFocusable;                                         // 0x043D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	EWindowVisibility                                  WindowVisibility;                                         // 0x043E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bApplyGammaCorrection;                                    // 0x043F(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bIsTwoSided;                                              // 0x046D(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      TickWhenOffscreen;                                        // 0x046E(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bAddedToScreen;                                           // 0x04E0(0x0001) (ZeroConstructor, Transient, DuplicateTransient, IsPlainOldData)
	unsigned char                                      bEditTimeUsable;                                          // 0x04E1(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UnknownData02[0x28];                                      // 0x04F8(0x0028) MISSED OFFSET
...
{
public:
	struct FScriptMulticastDelegate                    OnHoveredWidgetChanged;                                   // 0x01F0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	...
	unsigned char                                      bEnableHitTesting;                                        // 0x0221(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bShowDebug;                                               // 0x0222(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FLinearColor                                DebugColor;                                               // 0x0224(0x0010) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0x7C];                                      // 0x0234(0x007C) MISSED OFFSET
	...
	unsigned char                                      bIsHoveredWidgetInteractable;                             // 0x03D8(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bIsHoveredWidgetFocusable;                                // 0x03D9(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      bIsHoveredWidgetHitTestVisible;                           // 0x03DA(0x0001) (ZeroConstructor, Transient, IsPlainOldData)
