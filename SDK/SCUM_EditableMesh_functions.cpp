...
// Parameters:
// TArray<struct FEdgeID>*        EdgeIDs                        (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)
// TArray<unsigned char>*         EdgesNewIsHard                 (ConstParm, Parm, OutParm, ZeroConstructor, ReferenceParm)

void UEditableMesh::SetEdgesHardness(TArray<struct FEdgeID>* EdgeIDs, TArray<unsigned char>* EdgesNewIsHard)
{
...
struct FTriangleID UEditableMesh::GetPolygonTriangulatedTriangle(struct FPolygonID* PolygonID, int* PolygonTriangleNumber)
{
