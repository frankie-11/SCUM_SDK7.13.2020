...
struct FProcMeshTangent
{
	...
	unsigned char                                      bFlipTangentY;                                            // 0x000C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FProcMeshSection
{
	...
	unsigned char                                      bEnableCollision;                                         // 0x003C(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bSectionVisible;                                          // 0x003D(0x0001) (ZeroConstructor, IsPlainOldData)
};
