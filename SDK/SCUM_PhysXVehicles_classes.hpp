...
public:
	...
	unsigned char                                      bDeprecatedSpringOffsetMode : 1;                          // 0x0140(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bReverseAsBrake : 1;                                      // 0x0140(0x0001) (Edit BITFIELD: 0202)
	unsigned char                                      bUseRVOAvoidance : 1;                                     // 0x0140(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      bRawHandbrakeInput : 1;                                   // 0x0140(0x0001) (Transient BITFIELD: 0808)
	unsigned char                                      bRawGearUpInput : 1;                                      // 0x0140(0x0001) (Transient BITFIELD: 1010)
	unsigned char                                      bRawGearDownInput : 1;                                    // 0x0140(0x0001) (Transient BITFIELD: 2020)
	unsigned char                                      bWasAvoidanceUpdated : 1;                                 // 0x0144(0x0001) (Transient BITFIELD: 0101)
	...
	unsigned char                                      UnknownData02[0x24];                                      // 0x0264(0x0024) MISSED OFFSET
...
public:
	...
	unsigned char                                      bDontCreateShape;                                         // 0x0030(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      bAutoAdjustCollisionSize;                                 // 0x0031(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bAffectedByHandbrake;                                     // 0x0054(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	class UWheeledVehicleMovementComponent*            VehicleMovement;                                          // 0x0280(0x0008) (Edit, BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
