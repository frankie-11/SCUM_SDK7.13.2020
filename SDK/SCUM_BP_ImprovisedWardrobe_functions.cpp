...
void ABP_ImprovisedWardrobe_C::OnRep_InventoryCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.StorageItem.OnRep_InventoryCount");

	ABP_ImprovisedWardrobe_C_OnRep_InventoryCount_Params params;
...
void ABP_ImprovisedWardrobe_C::BP_OnNumContainedItemsChanged(int* numContainedItems)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.StorageItem.BP_OnNumContainedItemsChanged");

	ABP_ImprovisedWardrobe_C_BP_OnNumContainedItemsChanged_Params params;
