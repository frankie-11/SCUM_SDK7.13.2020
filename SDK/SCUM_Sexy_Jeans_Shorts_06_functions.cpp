...
void ASexy_Jeans_Shorts_06_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ASexy_Jeans_Shorts_06_C_UpdateMaterialParamsOnClients_Params params;
...
void ASexy_Jeans_Shorts_06_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ASexy_Jeans_Shorts_06_C_SetDirtiness_Params params;
...
void ASexy_Jeans_Shorts_06_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ASexy_Jeans_Shorts_06_C_OnRep_MaterialParameters_Params params;
...
int ASexy_Jeans_Shorts_06_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	ASexy_Jeans_Shorts_06_C_GetWarmth_Params params;
...
int ASexy_Jeans_Shorts_06_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ASexy_Jeans_Shorts_06_C_GetCapacityY_Params params;
...
int ASexy_Jeans_Shorts_06_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ASexy_Jeans_Shorts_06_C_GetCapacityX_Params params;
