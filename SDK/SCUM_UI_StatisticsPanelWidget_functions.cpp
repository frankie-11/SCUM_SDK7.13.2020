...
// (NetReliable, NetRequest, Exec, Event, Static, NetMulticast, MulticastDelegate, Public, NetServer, HasOutParms, DLLImport, BlueprintCallable, BlueprintEvent)
// Parameters:
// struct FGeometry*              MyGeometry                     (BlueprintVisible, BlueprintReadOnly, Parm, IsPlainOldData)
// struct FKeyEvent*              InKeyEvent                     (BlueprintVisible, BlueprintReadOnly, Parm)
// struct FEventReply             ReturnValue                    (Parm, OutParm, ReturnParm)

struct FEventReply UUI_StatisticsPanelWidget_C::STATIC_OnPreviewKeyDown(struct FGeometry* MyGeometry, struct FKeyEvent* InKeyEvent)
{
...
// (Net, NetReliable, Static, Public, Private, Delegate, NetServer, NetClient, BlueprintEvent, Const, NetValidate)

void UUI_StatisticsPanelWidget_C::STATIC_Construct()
{
...
// (Net, Exec, Native, Event, NetResponse, Public, Private, Delegate, NetServer, NetClient, BlueprintEvent, Const, NetValidate)
...
// (NetReliable, Static, Public, Private, Delegate, NetServer, NetClient, BlueprintEvent, Const, NetValidate)
...
// (NetRequest, Native, NetResponse, NetMulticast, Delegate, NetServer, HasOutParms, HasDefaults, NetClient, BlueprintCallable, BlueprintPure, Const)
// Parameters:
