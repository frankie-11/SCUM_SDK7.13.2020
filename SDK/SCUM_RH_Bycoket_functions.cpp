...
void ARH_Bycoket_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ARH_Bycoket_C_UpdateMaterialParamsOnClients_Params params;
...
void ARH_Bycoket_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ARH_Bycoket_C_SetDirtiness_Params params;
...
void ARH_Bycoket_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ARH_Bycoket_C_OnRep_MaterialParameters_Params params;
