...
void ABP_WeaponSightBase_C::STATIC_OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSightBase_C::STATIC_ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
