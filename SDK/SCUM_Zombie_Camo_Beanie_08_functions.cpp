...
void AZombie_Camo_Beanie_08_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Camo_Beanie_08_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Camo_Beanie_08_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Camo_Beanie_08_C_SetDirtiness_Params params;
...
void AZombie_Camo_Beanie_08_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Camo_Beanie_08_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Camo_Beanie_08_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Camo_Beanie_08_C_GetWarmth_Params params;
...
int AZombie_Camo_Beanie_08_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Camo_Beanie_08_C_GetCapacityY_Params params;
...
int AZombie_Camo_Beanie_08_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Camo_Beanie_08_C_GetCapacityX_Params params;
