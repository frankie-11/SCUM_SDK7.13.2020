...
void ACal_50BMG_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	ACal_50BMG_C_SetAmmoCount_Params params;
	params.count = count;
...
void ACal_50BMG_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	ACal_50BMG_C_Client_SetAmmoCount_Params params;
	params.count = count;
