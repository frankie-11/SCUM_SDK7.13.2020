...
void A05_Teeth_Necklace_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	A05_Teeth_Necklace_C_UpdateMaterialParamsOnClients_Params params;
...
void A05_Teeth_Necklace_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	A05_Teeth_Necklace_C_SetDirtiness_Params params;
...
void A05_Teeth_Necklace_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	A05_Teeth_Necklace_C_OnRep_MaterialParameters_Params params;
...
int A05_Teeth_Necklace_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	A05_Teeth_Necklace_C_GetCapacityY_Params params;
...
int A05_Teeth_Necklace_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	A05_Teeth_Necklace_C_GetCapacityX_Params params;
