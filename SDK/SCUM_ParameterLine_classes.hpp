...
public:
	...
	struct FText                                       _defaultTitle;                                            // 0x02C0(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FText                                       _parameterName;                                           // 0x02D8(0x0018) (Edit, BlueprintVisible)
	struct FText                                       _parameterValueText;                                      // 0x02F0(0x0018) (Edit, BlueprintVisible)
	struct FText                                       _maxValueText;                                            // 0x0308(0x0018) (Edit, BlueprintVisible)
	...
	void STATIC_SetParameterValueSlashText(float* Value, int* decimalPlaces);
	void STATIC_SetParameterValueTextDecimal(float* Value, int* decimalPlaces);
