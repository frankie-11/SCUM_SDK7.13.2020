...
public:
	...
	unsigned char                                      TransitionActive;                                         // 0x05FC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	unsigned char                                      ForecastActive;                                           // 0x0610(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      UpdateTime;                                               // 0x06CC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void STATIC_ResetWeatherForecastNextTime();
