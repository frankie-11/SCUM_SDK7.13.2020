...
{
public:
	unsigned char                                      bUseDrag;                                                 // 0x01F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDebugOn;                                                 // 0x01F1(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      ClampMaxVelocity;                                         // 0x0114(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      DrawDebugPoints;                                          // 0x0140(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      EnableStayUprightConstraint;                              // 0x0141(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      EnableWaveForces;                                         // 0x0158(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      ClampMaxVelocity;                                         // 0x0214(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      ApplyForceToBones;                                        // 0x0230(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      SnapToSurfaceIfNoPhysics;                                 // 0x0231(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      TwoGerstnerIterations;                                    // 0x0232(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      DrawDebugPoints;                                          // 0x0258(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      EnableStayUprightConstraint;                              // 0x0259(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      EnableWaveForces;                                         // 0x0270(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      ClampMaxVelocity;                                         // 0x071C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      DrawDebugPoints;                                          // 0x0728(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      EnableWaveForces;                                         // 0x0729(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      bVerticalForcesOnly;                                      // 0x0470(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseWaterPatch;                                           // 0x0471(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseStaticForces;                                         // 0x0472(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bUseDynamicForces;                                        // 0x0473(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	class AOceanManager*                               OceanManager;                                             // 0x0478(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawForceArrows;                                         // 0x0480(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawWaterline;                                           // 0x0481(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawVertices;                                            // 0x0482(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawTriangles;                                           // 0x0483(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawSubtriangles;                                        // 0x0484(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              ForceArrowSize;                                           // 0x0488(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bOverrideMeshDensity;                                     // 0x048C(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              MeshDensity;                                              // 0x0490(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bOverrideMass;                                            // 0x0494(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      attachToPlayer;                                           // 0x0244(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      DebugMode;                                                // 0x0245(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      isLeader;                                                 // 0x0290(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      DebugMode;                                                // 0x0338(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData02[0xBF];                                      // 0x0339(0x00BF) MISSED OFFSET
...
{
public:
	unsigned char                                      UpdateInEditor;                                           // 0x01F0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      ScaleByDistance;                                          // 0x01FC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
{
public:
	unsigned char                                      EnableGerstnerWaves;                                      // 0x0218(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bEnableLandscapeModulation;                               // 0x0254(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bAllowDaylightSavings;                                    // 0x0244(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDaylightSavingsActive;                                   // 0x0245(0x0001) (BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bOnlyCollidingComponents;                                 // 0x00B4(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	float                                              GridSizeMultiplier;                                       // 0x00B8(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawUsedTriangles;                                       // 0x00BC(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawHeightmap;                                           // 0x00BD(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	unsigned char                                      UnknownData00[0x62];                                      // 0x00BE(0x0062) MISSED OFFSET
