...
void AHoodie_04_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHoodie_04_C_UpdateMaterialParamsOnClients_Params params;
...
void AHoodie_04_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHoodie_04_C_SetDirtiness_Params params;
