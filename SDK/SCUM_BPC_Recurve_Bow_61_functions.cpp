...
void ABPC_Recurve_Bow_60_C::STATIC_ReceiveTick(float* DeltaSeconds)
{
	static auto fn = UObject::FindObject<UFunction>("Function Recurve_Bow.Recurve_Bow_C.ReceiveTick");

	ABPC_Recurve_Bow_60_C_ReceiveTick_Params params;
...
void ABPC_Recurve_Bow_60_C::STATIC_ExecuteUbergraph_Recurve_Bow(int* EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function Recurve_Bow.Recurve_Bow_C.ExecuteUbergraph_Recurve_Bow");

	ABPC_Recurve_Bow_60_C_ExecuteUbergraph_Recurve_Bow_Params params;
