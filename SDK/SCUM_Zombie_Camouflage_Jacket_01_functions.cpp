...
void AZombie_Camouflage_Jacket_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Camouflage_Jacket_01_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Camouflage_Jacket_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Camouflage_Jacket_01_C_SetDirtiness_Params params;
...
void AZombie_Camouflage_Jacket_01_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Camouflage_Jacket_01_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Camouflage_Jacket_01_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Camouflage_Jacket_01_C_GetWarmth_Params params;
...
int AZombie_Camouflage_Jacket_01_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Camouflage_Jacket_01_C_GetCapacityY_Params params;
...
int AZombie_Camouflage_Jacket_01_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Camouflage_Jacket_01_C_GetCapacityX_Params params;
