...
void ABP_FlareItem_C::SwitchPointLight(bool* turnOn)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.SwitchPointLight");

	ABP_FlareItem_C_SwitchPointLight_Params params;
...
void ABP_FlareItem_C::SetState(EFlareIgniteState* State)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.SetState");

	ABP_FlareItem_C_SetState_Params params;
	params.State = State;
...
void ABP_FlareItem_C::RequestPrisonerIgniteFlare(class APrisoner** Prisoner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.RequestPrisonerIgniteFlare");

	ABP_FlareItem_C_RequestPrisonerIgniteFlare_Params params;
...
void ABP_FlareItem_C::Ignite(class APrisoner** Prisoner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.Ignite");

	ABP_FlareItem_C_Ignite_Params params;
	params.Prisoner = Prisoner;
...
EFlareIgniteState ABP_FlareItem_C::GetState()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.FlareItem.GetState");

	ABP_FlareItem_C_GetState_Params params;
