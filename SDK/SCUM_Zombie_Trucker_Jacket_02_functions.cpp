...
void AZombie_Trucker_Jacket_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_Trucker_Jacket_02_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_Trucker_Jacket_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_Trucker_Jacket_02_C_SetDirtiness_Params params;
...
void AZombie_Trucker_Jacket_02_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_Trucker_Jacket_02_C_OnRep_MaterialParameters_Params params;
...
int AZombie_Trucker_Jacket_02_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AZombie_Trucker_Jacket_02_C_GetWarmth_Params params;
...
int AZombie_Trucker_Jacket_02_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_Trucker_Jacket_02_C_GetCapacityY_Params params;
...
int AZombie_Trucker_Jacket_02_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_Trucker_Jacket_02_C_GetCapacityX_Params params;
