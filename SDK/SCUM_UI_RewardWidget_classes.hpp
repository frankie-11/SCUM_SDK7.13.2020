...
// WidgetBlueprintGeneratedClass UI_RewardWidget.UI_RewardWidget_C
// 0x0008 (0x0248 - 0x0240)
class UUI_RewardWidget_C : public UMissionRewardWidget
{
public:
	...
	{
		static auto ptr = UObject::FindClass("WidgetBlueprintGeneratedClass UI_RewardWidget.UI_RewardWidget_C");
		return ptr;
	}
