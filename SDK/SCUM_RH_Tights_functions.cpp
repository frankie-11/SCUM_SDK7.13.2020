...
void ARH_Tights_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ARH_Tights_C_UpdateMaterialParamsOnClients_Params params;
...
void ARH_Tights_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ARH_Tights_C_SetDirtiness_Params params;
