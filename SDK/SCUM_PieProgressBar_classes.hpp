...
public:
	...
	struct FText STATIC_GetPercentageText();
	void STATIC_SetImageColor(class UImage** Image, struct FLinearColor* Color);
	void STATIC_SetTextColor(class UTextBlock** textWidget, struct FLinearColor* Color);
