...
class U590A1_Reload_Event_Chamber_C : public UInsertCartridge
{
public:
	...
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass 590A1_Reload_Event_Chamber.590A1_Reload_Event_Chamber_C");
		return ptr;
	}
	...
	void ExecuteUbergraph_590A1_Reload_Event_Chamber(int* EntryPoint);
};
