...
{
	unsigned char                                      bCanEditCompletionMode;                                   // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneEasingSettings
{
	...
	unsigned char                                      bManualEaseIn;                                            // 0x0018(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bManualEaseOut;                                           // 0x0030(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FOptionalMovieSceneBlendType
{
	...
	unsigned char                                      bIsValid;                                                 // 0x0001(0x0001) (ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      bCanEvaluateNearestSection : 1;                           // 0x0000(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bEvalNearestSection : 1;                                  // 0x0000(0x0001) (Edit BITFIELD: 0202)
	unsigned char                                      bEvaluateInPreroll : 1;                                   // 0x0000(0x0001) (Edit BITFIELD: 0404)
	unsigned char                                      bEvaluateInPostroll : 1;                                  // 0x0000(0x0001) (Edit BITFIELD: 0808)
	unsigned char                                      bEvaluateNearestSection : 1;                              // 0x0000(0x0001) (Deprecated BITFIELD: 1010)
};
...
struct FMovieSceneEvaluationTrack
{
	...
	unsigned char                                      bEvaluateInPreroll : 1;                                   // 0x00F0(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bEvaluateInPostroll : 1;                                  // 0x00F0(0x0001) ( BITFIELD: 0202)
	unsigned char                                      bTearDownPriority : 1;                                    // 0x00F0(0x0001) ( BITFIELD: 0404)
};
...
{
	unsigned char                                      bAutoPlay : 1;                                            // 0x0000(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	...
	unsigned char                                      bRandomStartTime : 1;                                     // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bRestoreState : 1;                                        // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      bDisableMovementInput : 1;                                // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      bDisableLookAtInput : 1;                                  // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      bHidePlayer : 1;                                          // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
	unsigned char                                      bHideHud : 1;                                             // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 2020)
	unsigned char                                      bDisableCameraCuts : 1;                                   // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 4040)
	unsigned char                                      bPauseAtEnd : 1;                                          // 0x0010(0x0001) (Edit, BlueprintVisible BITFIELD: 8080)
};
...
struct FMovieSceneSpawnable
{
	...
	unsigned char                                      bContinuouslyRespawn;                                     // 0x0040(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneBindingOverrideData
{
	...
	unsigned char                                      bOverridesDefault;                                        // 0x0020(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      bExpanded;                                                // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
};
...
struct FMovieSceneBoolChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      bHasDefaultValue;                                         // 0x0019(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneFloatChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      bHasDefaultValue;                                         // 0x0034(0x0001) (ZeroConstructor, IsPlainOldData)
...
struct FMovieSceneIntegerChannel : public FMovieSceneChannel
{
	...
	unsigned char                                      bHasDefaultValue;                                         // 0x001C(0x0001) (ZeroConstructor, IsPlainOldData)
...
{
	unsigned char                                      bShowVerticalFrames : 1;                                  // 0x0000(0x0001) (Edit BITFIELD: 0101)
};
