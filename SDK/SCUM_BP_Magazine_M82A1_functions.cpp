...
void ABP_Magazine_M82A1_C::SetAmmoCount(int* Amount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.SetAmmoCount");

	ABP_Magazine_M82A1_C_SetAmmoCount_Params params;
...
void ABP_Magazine_M82A1_C::Server_InsertCartridgeIntoMagazine(class AAmmunitionItem** ammo)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Server_InsertCartridgeIntoMagazine");

	ABP_Magazine_M82A1_C_Server_InsertCartridgeIntoMagazine_Params params;
	params.ammo = ammo;
...
void ABP_Magazine_M82A1_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.OnRep_AmmoCountOwnerHelper");

	ABP_Magazine_M82A1_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ABP_Magazine_M82A1_C::Multicast_SetLoadedVariables(int* ammoCount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Multicast_SetLoadedVariables");

	ABP_Magazine_M82A1_C_Multicast_SetLoadedVariables_Params params;
...
class UClass* ABP_Magazine_M82A1_C::GetProjectileClass()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.GetProjectileClass");

	ABP_Magazine_M82A1_C_GetProjectileClass_Params params;
