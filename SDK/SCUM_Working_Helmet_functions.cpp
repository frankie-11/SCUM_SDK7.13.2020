...
void AWorking_Helmet_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AWorking_Helmet_C_UpdateMaterialParamsOnClients_Params params;
...
void AWorking_Helmet_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AWorking_Helmet_C_SetDirtiness_Params params;
...
void AWorking_Helmet_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AWorking_Helmet_C_OnRep_MaterialParameters_Params params;
