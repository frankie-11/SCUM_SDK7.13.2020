...
void AMilitary_Cap_06_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitary_Cap_06_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitary_Cap_06_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitary_Cap_06_C_SetDirtiness_Params params;
...
void AMilitary_Cap_06_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitary_Cap_06_C_OnRep_MaterialParameters_Params params;
