...
public:
	...
	unsigned char                                      bDrawIndicatorLines;                                      // 0x0054(0x0001) (ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      bDepthTested;                                             // 0x0070(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawSecondaryLines;                                      // 0x0071(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bExplicitShowWireframe;                                   // 0x0430(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bBuildSpatialDataStructure;                               // 0x0038(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawOnTop;                                               // 0x0039(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bExplicitShowWireframe;                                   // 0x0438(0x0001) (ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawOnTop;                                               // 0x0439(0x0001) (ZeroConstructor, IsPlainOldData)
