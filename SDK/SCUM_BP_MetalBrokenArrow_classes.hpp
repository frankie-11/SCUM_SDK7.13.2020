...
// BlueprintGeneratedClass BP_MetalBrokenArrow.BP_MetalBrokenArrow_C
// 0x0000 (0x0670 - 0x0670)
class ABP_MetalBrokenArrow_C : public ABrokenArrow
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_MetalBrokenArrow.BP_MetalBrokenArrow_C");
		return ptr;
	}
