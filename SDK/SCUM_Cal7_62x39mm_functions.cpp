...
void ACal7_62x39mm_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	ACal7_62x39mm_C_SetAmmoCount_Params params;
	params.count = count;
...
void ACal7_62x39mm_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCountOwnerHelper");

	ACal7_62x39mm_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ACal7_62x39mm_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	ACal7_62x39mm_C_Client_SetAmmoCount_Params params;
	params.count = count;
