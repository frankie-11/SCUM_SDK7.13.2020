...
struct ABP_Magazine_AKS_74U_C_SetAmmoCount_Params
{
	int*                                               Amount;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function ConZ.WeaponAttachmentMagazine.Server_InsertCartridgeIntoMagazine
struct ABP_Magazine_AKS_74U_C_Server_InsertCartridgeIntoMagazine_Params
{
