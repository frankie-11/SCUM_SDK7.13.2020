...
void ABaseball_Cap_16_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABaseball_Cap_16_C_UpdateMaterialParamsOnClients_Params params;
...
void ABaseball_Cap_16_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABaseball_Cap_16_C_SetDirtiness_Params params;
...
void ABaseball_Cap_16_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABaseball_Cap_16_C_OnRep_MaterialParameters_Params params;
