...
void ACal22_Ammobox_Open_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	ACal22_Ammobox_Open_C_SetAmmoCount_Params params;
	params.count = count;
...
void ACal22_Ammobox_Open_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCountOwnerHelper");

	ACal22_Ammobox_Open_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ACal22_Ammobox_Open_C::OnRep_AmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCount");

	ACal22_Ammobox_Open_C_OnRep_AmmoCount_Params params;
...
int ACal22_Ammobox_Open_C::GetAmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.GetAmmoCount");

	ACal22_Ammobox_Open_C_GetAmmoCount_Params params;
...
void ACal22_Ammobox_Open_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	ACal22_Ammobox_Open_C_Client_SetAmmoCount_Params params;
	params.count = count;
