...
void ARedneck_Rat_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ARedneck_Rat_C_UpdateMaterialParamsOnClients_Params params;
...
void ARedneck_Rat_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ARedneck_Rat_C_SetDirtiness_Params params;
...
void ARedneck_Rat_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ARedneck_Rat_C_OnRep_MaterialParameters_Params params;
