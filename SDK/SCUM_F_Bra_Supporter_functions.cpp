...
void AF_Bra_Supporter_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AF_Bra_Supporter_C_UpdateMaterialParamsOnClients_Params params;
...
void AF_Bra_Supporter_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AF_Bra_Supporter_C_SetDirtiness_Params params;
...
void AF_Bra_Supporter_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AF_Bra_Supporter_C_OnRep_MaterialParameters_Params params;
