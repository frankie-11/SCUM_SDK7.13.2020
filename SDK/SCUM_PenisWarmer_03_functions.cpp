...
void APenisWarmer_03_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	APenisWarmer_03_C_UpdateMaterialParamsOnClients_Params params;
...
void APenisWarmer_03_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	APenisWarmer_03_C_SetDirtiness_Params params;
...
void APenisWarmer_03_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	APenisWarmer_03_C_OnRep_MaterialParameters_Params params;
