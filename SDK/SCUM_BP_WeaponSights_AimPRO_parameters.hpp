...
struct ABP_WeaponSights_AimPRO_C_OnAttachedToItem_Params
{
	class AItem**                                      Item;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_WeaponSightBase.BP_WeaponSightBase_C.OnDetachedFromItem
struct ABP_WeaponSights_AimPRO_C_OnDetachedFromItem_Params
{
	class AItem**                                      Item;                                                     // (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)
};

// Function BP_WeaponSightBase.BP_WeaponSightBase_C.ExecuteUbergraph_BP_WeaponSightBase
struct ABP_WeaponSights_AimPRO_C_ExecuteUbergraph_BP_WeaponSightBase_Params
{
