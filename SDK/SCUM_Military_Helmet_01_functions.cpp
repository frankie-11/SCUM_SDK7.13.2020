...
void AMilitary_Helmet_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitary_Helmet_01_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitary_Helmet_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitary_Helmet_01_C_SetDirtiness_Params params;
...
void AMilitary_Helmet_01_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitary_Helmet_01_C_OnRep_MaterialParameters_Params params;
...
int AMilitary_Helmet_01_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AMilitary_Helmet_01_C_GetWarmth_Params params;
...
int AMilitary_Helmet_01_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AMilitary_Helmet_01_C_GetCapacityY_Params params;
...
int AMilitary_Helmet_01_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AMilitary_Helmet_01_C_GetCapacityX_Params params;
