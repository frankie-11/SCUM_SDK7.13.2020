...
void ABP_WeaponSights_OKP_7_Holographic_C::STATIC_OnDetachedFromItem(class AItem** Item)
{
...
void ABP_WeaponSights_OKP_7_Holographic_C::STATIC_ExecuteUbergraph_BP_WeaponSightBase(int* EntryPoint)
{
