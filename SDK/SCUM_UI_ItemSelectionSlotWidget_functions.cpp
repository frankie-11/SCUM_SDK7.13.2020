...
// (Net, NetReliable, NetRequest, NetResponse, Static, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
...
// (Net, NetRequest, Exec, Native, NetResponse, Static, NetMulticast, Public, Private, NetServer, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure, NetValidate)
// Parameters:
// int                            SelectedIndex                  (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UUI_ItemSelectionSlotWidget_C::STATIC_GetSelectedIndex(int* SelectedIndex)
{
...
// (NetRequest, Exec, Native, NetResponse, Static, NetMulticast, Public, Private, NetServer, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure, NetValidate)
// Parameters:
// int                            ReturnValue                    (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)

int UUI_ItemSelectionSlotWidget_C::STATIC_GetSelectionCount()
{
...
// (Net, NetReliable, NetRequest, Event, NetResponse, MulticastDelegate, HasOutParms, BlueprintCallable, BlueprintEvent, BlueprintPure, NetValidate)
// Parameters:
...
void UUI_ItemSelectionSlotWidget_C::STATIC_ClearSelections()
{
...
// (Net, NetRequest, Exec, Event, NetResponse, MulticastDelegate, HasOutParms, BlueprintCallable, BlueprintEvent, BlueprintPure, NetValidate)
// Parameters:
// TArray<class UClass*>          NewParam                       (Parm, OutParm, ZeroConstructor)
...
// (NetReliable, Native, Event, Static, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
// class UClass*                  MainItem                       (Parm, OutParm, ZeroConstructor, IsPlainOldData)

void UUI_ItemSelectionSlotWidget_C::STATIC_GetMainItem(class UClass** MainItem)
{
...
// (Net, NetRequest, Native, Event, Static, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
...
// (Exec, Native, Event, Static, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
...
// (Net, NetReliable, NetRequest, Exec, Event, Static, MulticastDelegate, Protected, Delegate, NetServer, HasOutParms, NetClient, NetValidate)
// Parameters:
// class UItemSelection**         Item                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData)

void UUI_ItemSelectionSlotWidget_C::STATIC_AddSelection(class UItemSelection** Item)
{
...
// (Net, NetReliable, Exec, Native, NetResponse, Static, NetMulticast, Public, Private, NetServer, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure, NetValidate)

void UUI_ItemSelectionSlotWidget_C::STATIC_Construct()
{
...
// (NetReliable, Exec, Native, NetResponse, Static, NetMulticast, Public, Private, NetServer, NetClient, BlueprintCallable, BlueprintEvent, BlueprintPure, NetValidate)

void UUI_ItemSelectionSlotWidget_C::STATIC_OnSynchronizeProperties()
{
...
// (Net, NetRequest, Exec, NetResponse, Static, MulticastDelegate, Protected, Delegate, NetClient, BlueprintCallable)
// Parameters:
