...
public:
	...
	unsigned char                                      bIgnoreRestartSelf : 1;                                   // 0x0068(0x0001) (Edit BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bDefineReferenceValue;                                    // 0x01A8(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	unsigned char                                      UnknownData00[0xF];                                       // 0x01A9(0x000F) MISSED OFFSET
	unsigned char                                      bWorkOnFloatValues : 1;                                   // 0x01B8(0x0001) ( BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bStopAILogicOnUnposses : 1;                               // 0x02C8(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bLOSflag : 1;                                             // 0x02C8(0x0001) ( BITFIELD: 0202)
	unsigned char                                      bSkipExtraLOSChecks : 1;                                  // 0x02C8(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x02C8(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      bWantsPlayerState : 1;                                    // 0x02C8(0x0001) (Edit, BlueprintVisible BITFIELD: 1010)
	unsigned char                                      bSetControlRotationFromPawnOrientation : 1;               // 0x02C8(0x0001) (Edit, BlueprintVisible BITFIELD: 2020)
	class UPathFollowingComponent*                     PathFollowingComponent;                                   // 0x02D0(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UBrainComponent*                             BrainComponent;                                           // 0x02D8(0x0008) (BlueprintVisible, ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UAIPerceptionComponent*                      PerceptionComponent;                                      // 0x02E0(0x0008) (Edit, ExportObject, ZeroConstructor, DisableEditOnInstance, EditConst, InstancedReference, IsPlainOldData)
	class UPawnActionsComponent*                       ActionsComp;                                              // 0x02E8(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UBlackboardComponent*                        Blackboard;                                               // 0x02F0(0x0008) (BlueprintVisible, ExportObject, BlueprintReadOnly, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UGameplayTasksComponent*                     CachedGameplayTasksComponent;                             // 0x02F8(0x0008) (ExportObject, ZeroConstructor, InstancedReference, IsPlainOldData)
	class UClass*                                      DefaultNavigationFilterClass;                             // 0x0300(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    ReceiveMoveCompleted;                                     // 0x0308(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	class UCharacterMovementComponent*                 CharacterMovement;                                        // 0x0260(0x0008) (ExportObject, ZeroConstructor, Transient, InstancedReference, IsPlainOldData)
...
public:
	...
	struct FScriptMulticastDelegate                    OnFail;                                                   // 0x0038(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
public:
	...
	unsigned char                                      BoolValue;                                                // 0x0038(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bInteger : 1;                                             // 0x0048(0x0001) (Edit BITFIELD: 0101)
...
public:
	...
	struct FScriptMulticastDelegate                    OnPerceptionUpdated;                                      // 0x0160(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x00E0(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnTargetPerceptionUpdated;                                // 0x0170(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
...
{
public:
	unsigned char                                      bAutoRegisterAsSource : 1;                                // 0x00B0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Config BITFIELD: 0101)
...
public:
	...
	class UClass* GetSenseClassForStimulus(class UObject** WorldContextObject, struct FAIStimulus* Stimulus);
};
...
public:
	...
	unsigned char                                      bWantsNewPawnNotification : 1;                            // 0x0030(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance BITFIELD: 0101)
	unsigned char                                      bAutoRegisterAllPawnsAsSources : 1;                       // 0x0030(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, Config, DisableEditOnInstance BITFIELD: 0202)
...
public:
	...
	void ReportDamageEvent(class UObject** WorldContextObject, class AActor** DamagedActor, class AActor** Instigator, float* DamageAmount, struct FVector* EventLocation, struct FVector* HitLocation);
};
...
public:
	...
	void ReportNoiseEvent(class UObject** WorldContextObject, struct FVector* NoiseLocation, float* Loudness, class AActor** Instigator, float* MaxRange, struct FName* Tag);
};
...
public:
	...
	unsigned char                                      bStartsEnabled : 1;                                       // 0x0030(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bUseLoSHearing : 1;                                       // 0x0058(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0101)
	...
	unsigned char                                      bHearingOcclusionEnabled;                                 // 0x0060(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	float                                              HearingRangeReductionIfOccluded;                          // 0x0064(0x0004) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	TEnumAsByte<ECollisionChannel>                     HearingOcclusionCollisionChannel;                         // 0x0068(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      bFinishMoveOnGoalOverlap;                                 // 0x0094(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, GlobalConfig, IsPlainOldData)
	unsigned char                                      bAcceptPartialPaths;                                      // 0x0095(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, GlobalConfig, IsPlainOldData)
	unsigned char                                      bAllowStrafing;                                           // 0x0096(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, GlobalConfig, IsPlainOldData)
	unsigned char                                      bEnableBTAITasks;                                         // 0x0097(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, GlobalConfig, IsPlainOldData)
	unsigned char                                      bAllowControllersAsEQSQuerier;                            // 0x0098(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, GlobalConfig, IsPlainOldData)
	unsigned char                                      bEnableDebuggerPlugin;                                    // 0x0099(0x0001) (Edit, ZeroConstructor, Config, DisableEditOnInstance, GlobalConfig, IsPlainOldData)
...
{
public:
	struct FScriptMulticastDelegate                    OnRequestFailed;                                          // 0x0070(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0070(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnMoveFinished;                                           // 0x0080(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0080(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	class UBlackboardData*                             BlackboardAsset;                                          // 0x00B8(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
	unsigned char                                      UnknownData00[0x20];                                      // 0x00C0(0x0020) MISSED OFFSET
	TArray<class UBlackboardKeyType*>                  KeyInstances;                                             // 0x00E0(0x0010) (ZeroConstructor, Transient)
...
public:
	...
	unsigned char                                      bHasSynchronizedKeys : 1;                                 // 0x0048(0x0001) ( BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bIsEnumNameValid : 1;                                     // 0x0048(0x0001) (Edit, DisableEditOnInstance, EditConst BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bApplyDecoratorScope : 1;                                 // 0x0088(0x0001) (Edit BITFIELD: 0101)
...
{
public:
	unsigned char                                      bUnknown0060_0101 : 1;                                    // 0x0060(0x0001) (EditMANUAL_ADD_BIT 0101)
	unsigned char                                      bInverseCondition : 1;                                    // 0x0060(0x0001) (Edit BITFIELD: 8080)
...
public:
	...
	unsigned char                                      bShowPropertyDetails : 1;                                 // 0x0098(0x0001) (Edit, DisableEditOnTemplate BITFIELD: 0101)
	unsigned char                                      bCheckConditionOnlyBlackBoardChanges : 1;                 // 0x0098(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0202)
	unsigned char                                      bIsObservingBB : 1;                                       // 0x0098(0x0001) ( BITFIELD: 0404)
...
public:
	...
	unsigned char                                      bUseSelf : 1;                                             // 0x00B8(0x0001) ( BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bUseParametrizedRadius : 1;                               // 0x00CC(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bUseNavAgentGoalLocation : 1;                             // 0x00CC(0x0001) (Edit BITFIELD: 0202)
	unsigned char                                      bPathFindingBasedTest : 1;                                // 0x00CC(0x0001) (Edit BITFIELD: 0404)
...
public:
	...
	unsigned char                                      bUseSelfAsOrigin : 1;                                     // 0x00C0(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bUseSelfAsObserved : 1;                                   // 0x00C0(0x0001) ( BITFIELD: 0202)
...
public:
	...
	unsigned char                                      bInfiniteLoop;                                            // 0x006C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bAddToExistingDuration;                                   // 0x0074(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	float                                              CooldownDuration;                                         // 0x0070(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bAddToExistingDuration;                                   // 0x0074(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bActivatesCooldown;                                       // 0x0075(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bCallTickOnSearchStart : 1;                               // 0x0068(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bRestartTimerOnEachActivation : 1;                        // 0x0068(0x0001) (Edit BITFIELD: 0202)
...
public:
	...
	unsigned char                                      bShowPropertyDetails : 1;                                 // 0x0090(0x0001) (Edit, DisableEditOnTemplate BITFIELD: 0101)
	unsigned char                                      bShowEventDetails : 1;                                    // 0x0090(0x0001) (Edit, DisableEditOnTemplate BITFIELD: 0202)
...
public:
	...
	unsigned char                                      bShowPropertyDetails : 1;                                 // 0x00A0(0x0001) (Edit, DisableEditOnTemplate BITFIELD: 0101)
...
{
public:
	unsigned char                                      bWaitForGameplayTask : 1;                                 // 0x0070(0x0001) (Edit BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bObserveBlackboardValue : 1;                              // 0x00AC(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bAllowStrafe : 1;                                         // 0x00AC(0x0001) (Edit BITFIELD: 0202)
	unsigned char                                      bAllowPartialPath : 1;                                    // 0x00AC(0x0001) (Edit BITFIELD: 0404)
	unsigned char                                      bTrackMovingGoal : 1;                                     // 0x00AC(0x0001) (Edit BITFIELD: 0808)
	unsigned char                                      bProjectGoalLocation : 1;                                 // 0x00AC(0x0001) (Edit BITFIELD: 1010)
	unsigned char                                      bReachTestIncludesAgentRadius : 1;                        // 0x00AC(0x0001) (Edit BITFIELD: 2020)
	unsigned char                                      bReachTestIncludesGoalRadius : 1;                         // 0x00AC(0x0001) (Edit BITFIELD: 4040)
	unsigned char                                      bStopOnOverlap : 1;                                       // 0x00AC(0x0001) (Edit, DisableEditOnTemplate, EditConst BITFIELD: 8080)
	unsigned char                                      bStopOnOverlapNeedsUpdate : 1;                            // 0x00AD(0x0001) ( BITFIELD: 0101)
...
{
public:
	unsigned char                                      bDisablePathUpdateOnGoalLocationChange : 1;               // 0x00B0(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bProjectVectorGoalToNavigation : 1;                       // 0x00B0(0x0001) ( BITFIELD: 0202)
	unsigned char                                      bUpdatedDeprecatedProperties : 1;                         // 0x00B0(0x0001) ( BITFIELD: 0404)
...
public:
	...
	unsigned char                                      bLooping : 1;                                             // 0x0078(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bNonBlocking : 1;                                         // 0x0078(0x0001) (Edit BITFIELD: 0202)
...
public:
	...
	unsigned char                                      bUseBBKey;                                                // 0x00F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bAddToExistingDuration;                                   // 0x0078(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bUnknown0070_0101 : 1;                                    // 0x0070(0x0001) (Edit, ConfigMANUAL_ADD_BIT 0101)
	unsigned char                                      bResolveCollisions : 1;                                   // 0x0070(0x0001) (Edit, Config BITFIELD: 1010)
...
public:
	...
	unsigned char                                      bAutoSortTests : 1;                                       // 0x0048(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bAllowDifferentItemTypes : 1;                             // 0x0060(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0101)
	unsigned char                                      bHasMatchingItemType : 1;                                 // 0x0060(0x0001) ( BITFIELD: 0202)
...
public:
	...
	unsigned char                                      bIncludeContextLocation : 1;                              // 0x0148(0x0001) (Edit BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bUseSpiralPattern;                                        // 0x0190(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	class UClass*                                      Center;                                                   // 0x0198(0x0008) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDefineArc : 1;                                           // 0x01A0(0x0001) (Edit BITFIELD: 0101)
...
public:
	...
	unsigned char                                      bIgnoreAnyContextActorsWhenGeneratingCircle;              // 0x0178(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FAIDataProviderFloatValue                   CircleCenterZOffset;                                      // 0x0180(0x0030) (Edit)
	struct FEnvTraceData                               TraceData;                                                // 0x01B0(0x0030) (Edit)
	unsigned char                                      bDefineArc : 1;                                           // 0x01E0(0x0001) (Edit BITFIELD: 0101)
...
public:
	...
	struct FScriptMulticastDelegate                    OnQueryFinishedEvent;                                     // 0x0068(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x0064(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      bTestQueriesUsingBreadth;                                 // 0x0130(0x0001) (ZeroConstructor, Config, IsPlainOldData)
...
public:
	...
	unsigned char                                      bAbsoluteValue;                                           // 0x0201(0x0001) (Edit, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
...
public:
	...
	unsigned char                                      bUpdatedToUseQuery;                                       // 0x0208(0x0001) (ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bDoComplexVolumeTest : 1;                                 // 0x01D0(0x0001) (Edit BITFIELD: 0101)
...
public:
	...
	TArray<struct FEnvNamedValue>                      QueryParams;                                              // 0x0638(0x0010) (Edit, ZeroConstructor, EditConst)
	TArray<struct FAIDynamicParam>                     QueryConfig;                                              // 0x0648(0x0010) (Edit, ZeroConstructor)
	...
	EEnvQueryHightlightMode                            HighlightMode;                                            // 0x0660(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bDrawLabels : 1;                                          // 0x0664(0x0001) (Edit BITFIELD: 0101)
	unsigned char                                      bDrawFailedItems : 1;                                     // 0x0664(0x0001) (Edit BITFIELD: 0202)
	unsigned char                                      bReRunQueryOnlyOnFinishedMove : 1;                        // 0x0664(0x0001) (Edit BITFIELD: 0404)
	unsigned char                                      bShouldBeVisibleInGame : 1;                               // 0x0664(0x0001) (Edit BITFIELD: 0808)
	unsigned char                                      bTickDuringGame : 1;                                      // 0x0664(0x0001) (Edit BITFIELD: 1010)
	TEnumAsByte<EEnvQueryRunMode>                      QueryingMode;                                             // 0x0668(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FNavAgentProperties                         NavAgentProperties;                                       // 0x0670(0x0030) (Edit)
...
{
public:
	class UNavLocalGridManager*                        GridManager;                                              // 0x0258(0x0008) (ZeroConstructor, Transient, IsPlainOldData)
...
public:
	...
	TArray<struct FNavigationLink>                     PointLinks;                                               // 0x0228(0x0010) (Edit, ZeroConstructor)
	TArray<struct FNavigationSegmentLink>              SegmentLinks;                                             // 0x0238(0x0010) (ZeroConstructor)
	class UNavLinkCustomComponent*                     SmartLinkComp;                                            // 0x0248(0x0008) (Edit, ExportObject, ZeroConstructor, EditConst, InstancedReference, IsPlainOldData)
	unsigned char                                      bSmartLinkIsRelevant;                                     // 0x0250(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	struct FScriptMulticastDelegate                    OnSmartLinkReached;                                       // 0x0258(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0251(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
public:
	...
	unsigned char                                      bAllowNewSameClassInstance : 1;                           // 0x0080(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, DisableEditOnInstance BITFIELD: 0101)
	unsigned char                                      bReplaceActiveSameClassInstance : 1;                      // 0x0080(0x0001) (Edit, BlueprintVisible, DisableEditOnInstance BITFIELD: 0202)
	unsigned char                                      bShouldPauseMovement : 1;                                 // 0x0080(0x0001) (Edit, BlueprintVisible, DisableEditOnInstance BITFIELD: 0404)
	unsigned char                                      bAlwaysNotifyOnFinished : 1;                              // 0x0080(0x0001) (Edit, BlueprintVisible, DisableEditOnInstance BITFIELD: 0808)
...
public:
	...
	unsigned char                                      bAllowStrafe : 1;                                         // 0x00B8(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	unsigned char                                      bFinishOnOverlap : 1;                                     // 0x00B8(0x0001) ( BITFIELD: 0202)
	unsigned char                                      bUsePathfinding : 1;                                      // 0x00B8(0x0001) ( BITFIELD: 0404)
	unsigned char                                      bAllowPartialPath : 1;                                    // 0x00B8(0x0001) ( BITFIELD: 0808)
	unsigned char                                      bProjectGoalToNavigation : 1;                             // 0x00B8(0x0001) ( BITFIELD: 1010)
	unsigned char                                      bUpdatePathToGoal : 1;                                    // 0x00B8(0x0001) ( BITFIELD: 2020)
	unsigned char                                      bAbortChildActionOnPathChange : 1;                        // 0x00B8(0x0001) ( BITFIELD: 4040)
...
public:
	...
	unsigned char                                      bEnableSensingUpdates : 1;                                // 0x00C4(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0101)
	unsigned char                                      bOnlySensePlayers : 1;                                    // 0x00C4(0x0001) (Edit, BlueprintVisible BITFIELD: 0202)
	unsigned char                                      bSeePawns : 1;                                            // 0x00C4(0x0001) (Edit, BlueprintVisible BITFIELD: 0404)
	unsigned char                                      bHearNoises : 1;                                          // 0x00C4(0x0001) (Edit, BlueprintVisible BITFIELD: 0808)
	unsigned char                                      UnknownData00[0xB];                                       // 0x00C5(0x000B) MISSED OFFSET
	struct FScriptMulticastDelegate                    OnSeePawn;                                                // 0x00D0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x00C5(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	struct FScriptMulticastDelegate                    OnHearNoise;                                              // 0x00E0(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData02[0xF];                                       // 0x00E0(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
