...
void ABulletproof_Vest_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABulletproof_Vest_02_C_UpdateMaterialParamsOnClients_Params params;
...
void ABulletproof_Vest_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABulletproof_Vest_02_C_SetDirtiness_Params params;
...
void ABulletproof_Vest_02_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABulletproof_Vest_02_C_OnRep_MaterialParameters_Params params;
...
int ABulletproof_Vest_02_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	ABulletproof_Vest_02_C_GetWarmth_Params params;
...
int ABulletproof_Vest_02_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ABulletproof_Vest_02_C_GetCapacityY_Params params;
...
int ABulletproof_Vest_02_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ABulletproof_Vest_02_C_GetCapacityX_Params params;
