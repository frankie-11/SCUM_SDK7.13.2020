...
void A12_Gauge_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	A12_Gauge_C_SetAmmoCount_Params params;
	params.count = count;
