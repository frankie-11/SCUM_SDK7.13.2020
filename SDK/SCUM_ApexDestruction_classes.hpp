...
{
public:
	unsigned char                                      bFractureEffectOverride : 1;                              // 0x0610(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
	...
	unsigned char                                      bEnableHardSleeping;                                      // 0x0628(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	struct FScriptMulticastDelegate                    OnComponentFracture;                                      // 0x0640(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData01[0xF];                                       // 0x0630(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      UnknownData02[0xA0];                                      // 0x0650(0x00A0) MISSED OFFSET
