...
void ATC_Backpack_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ATC_Backpack_C_UpdateMaterialParamsOnClients_Params params;
...
void ATC_Backpack_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ATC_Backpack_C_SetDirtiness_Params params;
...
void ATC_Backpack_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ATC_Backpack_C_OnRep_MaterialParameters_Params params;
