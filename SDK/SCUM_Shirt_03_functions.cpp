...
void AShirt_03_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AShirt_03_C_UpdateMaterialParamsOnClients_Params params;
...
void AShirt_03_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AShirt_03_C_SetDirtiness_Params params;
