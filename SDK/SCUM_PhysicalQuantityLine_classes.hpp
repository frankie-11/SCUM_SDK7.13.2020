...
public:
	...
	struct FText                                       _parameterValueText;                                      // 0x0250(0x0018) (Edit, BlueprintVisible)
	struct FText                                       _maxValueText;                                            // 0x0268(0x0018) (Edit, BlueprintVisible)
	struct FText                                       _measurementUnit;                                         // 0x0280(0x0018) (Edit, BlueprintVisible)
