...
void ABeenie_05_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABeenie_05_C_UpdateMaterialParamsOnClients_Params params;
...
void ABeenie_05_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABeenie_05_C_SetDirtiness_Params params;
...
void ABeenie_05_C::OnRep_MaterialParameters()
{
	...
	ABeenie_05_C_OnRep_MaterialParameters_Params params;
