...
void ABaseball_Cap_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABaseball_Cap_02_C_UpdateMaterialParamsOnClients_Params params;
...
void ABaseball_Cap_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABaseball_Cap_02_C_SetDirtiness_Params params;
...
void ABaseball_Cap_02_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABaseball_Cap_02_C_OnRep_MaterialParameters_Params params;
