...
void ABP_Bulletproof_Vest_03_Event_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABP_Bulletproof_Vest_03_Event_C_UpdateMaterialParamsOnClients_Params params;
...
void ABP_Bulletproof_Vest_03_Event_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABP_Bulletproof_Vest_03_Event_C_SetDirtiness_Params params;
...
void ABP_Bulletproof_Vest_03_Event_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ABP_Bulletproof_Vest_03_Event_C_OnRep_MaterialParameters_Params params;
...
int ABP_Bulletproof_Vest_03_Event_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	ABP_Bulletproof_Vest_03_Event_C_GetWarmth_Params params;
...
int ABP_Bulletproof_Vest_03_Event_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ABP_Bulletproof_Vest_03_Event_C_GetCapacityY_Params params;
...
int ABP_Bulletproof_Vest_03_Event_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ABP_Bulletproof_Vest_03_Event_C_GetCapacityX_Params params;
