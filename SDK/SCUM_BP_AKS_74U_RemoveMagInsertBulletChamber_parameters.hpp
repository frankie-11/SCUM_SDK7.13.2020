...
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_SetNextMontageSectionFromPrevious_Params
{
...
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_SetNextMontageSection_Params
{
	struct FName*                                      NextSection;                                              // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function ConZ.WeaponActionReloadSequence.OnMontageEnded
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_OnMontageEnded_Params
{
...
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_OnMontageBlendingOutStarted_Params
{
	class UAnimMontage**                               Montage;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
	bool*                                              interrupted;                                              // (Parm, ZeroConstructor, IsPlainOldData)
};
...
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_GetReloadData_Params
{
...
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_GetActiveAnimationWeapon_Params
{
	class UAnimMontage*                                ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function ConZ.WeaponActionReloadSequence.GetActiveAnimationBody
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_GetActiveAnimationBody_Params
{
	class UAnimMontage*                                ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function ConZ.WeaponActionReloadSequence.ExecuteUsingData
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_ExecuteUsingData_Params
{
...
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_End_Params
{
	bool*                                              Regular;                                                  // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function ConZ.WeaponActionReloadSequence.CanInterrupt
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_CanInterrupt_Params
{
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function ConZ.WeaponActionReloadSequence.CanExecuteUsingData
struct UBP_AKS_74U_RemoveMagInsertBulletChamber_C_CanExecuteUsingData_Params
{
	struct FWeaponReloadData*                          Data;                                                     // (ConstParm, Parm, OutParm, ReferenceParm)
	bool                                               ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};
