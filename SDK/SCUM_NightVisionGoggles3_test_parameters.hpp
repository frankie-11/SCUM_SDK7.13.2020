...
struct ANightVisionGoggles3_test_C_SetActivatedOnServer_Params
{
	bool*                                              Value;                                                    // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function ConZ.NightVisionGogglesItem.OnRep_Activated
struct ANightVisionGoggles3_test_C_OnRep_Activated_Params
{
};

// DelegateFunction ConZ.NightVisionGogglesItem.ActivatedChangedEvent__DelegateSignature
struct ANightVisionGoggles3_test_C_ActivatedChangedEvent__DelegateSignature_Params
{
