...
void ABP_Magazine_M9_C::Server_InsertCartridgeIntoMagazine(class AAmmunitionItem** ammo)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Server_InsertCartridgeIntoMagazine");

	ABP_Magazine_M9_C_Server_InsertCartridgeIntoMagazine_Params params;
	params.ammo = ammo;
...
void ABP_Magazine_M9_C::Multicast_SetLoadedVariables(int* ammoCount)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentMagazine.Multicast_SetLoadedVariables");

	ABP_Magazine_M9_C_Multicast_SetLoadedVariables_Params params;
