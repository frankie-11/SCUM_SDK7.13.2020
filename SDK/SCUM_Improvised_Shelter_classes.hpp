...
// BlueprintGeneratedClass Improvised_Shelter.Improvised_Shelter_C
// 0x0000 (0x0678 - 0x0678)
class AImprovised_Shelter_C : public AShelterItem
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass Improvised_Shelter.Improvised_Shelter_C");
		return ptr;
	}
