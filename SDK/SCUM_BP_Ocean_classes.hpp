...
public:
	...
	unsigned char                                      UpdateInEditor;                                           // 0x0468(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	unsigned char                                      ScaleByDistance;                                          // 0x0474(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
	...
	void STATIC_Set_Display_Parameters();
	void STATIC_Create_Wave_Set();
	void STATIC_UserConstructionScript();
	void ReceiveBeginPlay();
	void SetNetworkOffset(float* Offset);
	void MySetNetworkOffset(float* Offset);
	void STATIC_ExecuteUbergraph_BP_Ocean(int* EntryPoint);
};
