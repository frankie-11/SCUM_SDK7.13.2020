...
void AMilitaryBoots_Peace_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitaryBoots_Peace_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitaryBoots_Peace_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitaryBoots_Peace_C_SetDirtiness_Params params;
...
void AMilitaryBoots_Peace_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitaryBoots_Peace_C_OnRep_MaterialParameters_Params params;
...
int AMilitaryBoots_Peace_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AMilitaryBoots_Peace_C_GetWarmth_Params params;
...
int AMilitaryBoots_Peace_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AMilitaryBoots_Peace_C_GetCapacityY_Params params;
...
int AMilitaryBoots_Peace_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AMilitaryBoots_Peace_C_GetCapacityX_Params params;
