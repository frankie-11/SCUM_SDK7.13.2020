...
struct FAkPoly
{
	...
	unsigned char                                      EnableSurface;                                            // 0x0008(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
};
...
struct FMovieSceneFloatChannelSerializationHelper
{
	...
	unsigned char                                      bHasDefaultValue;                                         // 0x002C(0x0001) (ZeroConstructor, IsPlainOldData)
};
...
{
	unsigned char                                      bCurrentlyPlaying;                                        // 0x0000(0x0001) (ZeroConstructor, IsPlainOldData)
};
