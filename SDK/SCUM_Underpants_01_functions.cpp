...
void AUnderpants_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AUnderpants_01_C_UpdateMaterialParamsOnClients_Params params;
...
void AUnderpants_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AUnderpants_01_C_SetDirtiness_Params params;
...
void AUnderpants_01_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AUnderpants_01_C_OnRep_MaterialParameters_Params params;
