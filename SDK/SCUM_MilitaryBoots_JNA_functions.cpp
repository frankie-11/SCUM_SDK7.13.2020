...
void AMilitaryBoots_JNA_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitaryBoots_JNA_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitaryBoots_JNA_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitaryBoots_JNA_C_SetDirtiness_Params params;
...
void AMilitaryBoots_JNA_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitaryBoots_JNA_C_OnRep_MaterialParameters_Params params;
...
int AMilitaryBoots_JNA_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AMilitaryBoots_JNA_C_GetCapacityY_Params params;
...
int AMilitaryBoots_JNA_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AMilitaryBoots_JNA_C_GetCapacityX_Params params;
