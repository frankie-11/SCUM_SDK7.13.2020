...
void AWW2_German_Helmet_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AWW2_German_Helmet_C_UpdateMaterialParamsOnClients_Params params;
...
void AWW2_German_Helmet_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AWW2_German_Helmet_C_SetDirtiness_Params params;
...
void AWW2_German_Helmet_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AWW2_German_Helmet_C_OnRep_MaterialParameters_Params params;
...
int AWW2_German_Helmet_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AWW2_German_Helmet_C_GetCapacityY_Params params;
...
int AWW2_German_Helmet_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AWW2_German_Helmet_C_GetCapacityX_Params params;
