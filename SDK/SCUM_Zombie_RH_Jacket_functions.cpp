...
void AZombie_RH_Jacket_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AZombie_RH_Jacket_C_UpdateMaterialParamsOnClients_Params params;
...
void AZombie_RH_Jacket_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AZombie_RH_Jacket_C_SetDirtiness_Params params;
...
void AZombie_RH_Jacket_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AZombie_RH_Jacket_C_OnRep_MaterialParameters_Params params;
...
int AZombie_RH_Jacket_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AZombie_RH_Jacket_C_GetCapacityY_Params params;
...
int AZombie_RH_Jacket_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AZombie_RH_Jacket_C_GetCapacityX_Params params;
