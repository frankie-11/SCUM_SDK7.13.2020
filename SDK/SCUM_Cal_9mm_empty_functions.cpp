...
void ACal_9mm_empty_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	ACal_9mm_empty_C_SetAmmoCount_Params params;
	params.count = count;
...
void ACal_9mm_empty_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCountOwnerHelper");

	ACal_9mm_empty_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ACal_9mm_empty_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	ACal_9mm_empty_C_Client_SetAmmoCount_Params params;
	params.count = count;
