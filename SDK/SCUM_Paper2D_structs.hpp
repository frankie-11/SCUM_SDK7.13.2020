...
struct FPaperTerrainMaterialRule
{
	...
	unsigned char                                      bEnableCollision;                                         // 0x0028(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FSpriteGeometryShape
{
	...
	unsigned char                                      bNegativeWinding;                                         // 0x002C(0x0001) (Edit, ZeroConstructor, EditConst, IsPlainOldData)
};
...
struct FSpriteGeometryCollection
{
	...
	unsigned char                                      bAvoidVertexMerging;                                      // 0x001C(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
...
struct FSpriteDrawCallRecord
{
	...
	unsigned char                                      UnknownData01[0x84];                                      // 0x004C(0x0084) MISSED OFFSET
};
