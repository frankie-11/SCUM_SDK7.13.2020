...
void AMilitaryPants_04_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AMilitaryPants_04_C_UpdateMaterialParamsOnClients_Params params;
...
void AMilitaryPants_04_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AMilitaryPants_04_C_SetDirtiness_Params params;
...
void AMilitaryPants_04_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AMilitaryPants_04_C_OnRep_MaterialParameters_Params params;
...
int AMilitaryPants_04_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AMilitaryPants_04_C_GetCapacityY_Params params;
...
int AMilitaryPants_04_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AMilitaryPants_04_C_GetCapacityX_Params params;
