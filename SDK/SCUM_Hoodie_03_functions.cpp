...
void AHoodie_03_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AHoodie_03_C_UpdateMaterialParamsOnClients_Params params;
...
void AHoodie_03_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AHoodie_03_C_SetDirtiness_Params params;
