...
void ANightVisionGoggles_Test_C::SetActivatedOnServer(bool* Value)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.NightVisionGogglesItem.SetActivatedOnServer");

	ANightVisionGoggles_Test_C_SetActivatedOnServer_Params params;
	params.Value = Value;
...
void ANightVisionGoggles_Test_C::OnRep_Activated()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.NightVisionGogglesItem.OnRep_Activated");

	ANightVisionGoggles_Test_C_OnRep_Activated_Params params;
...
void ANightVisionGoggles_Test_C::ActivatedChangedEvent__DelegateSignature(class ANightVisionGogglesItem** sender)
{
	...
	ANightVisionGoggles_Test_C_ActivatedChangedEvent__DelegateSignature_Params params;
