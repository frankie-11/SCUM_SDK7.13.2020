...
// BlueprintGeneratedClass BP_WoodenBrokenArrow.BP_WoodenBrokenArrow_C
// 0x0000 (0x0670 - 0x0670)
class ABP_WoodenBrokenArrow_C : public ABrokenArrow
{
public:

	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass("BlueprintGeneratedClass BP_WoodenBrokenArrow.BP_WoodenBrokenArrow_C");
		return ptr;
	}
