...
{
	unsigned char                                      DefaultValue;                                             // 0x0028(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
};
...
struct FAIStimulus
{
	...
	unsigned char                                      bUnknown0038_0101 : 1;                                    // 0x0038(0x0001) (BlueprintVisibleMANUAL_ADD_BIT 0101)
	unsigned char                                      bSuccessfullySensed : 1;                                  // 0x0038(0x0001) (BlueprintVisible BITFIELD: 0202)
};
...
struct FActorPerceptionBlueprintInfo
{
	...
	unsigned char                                      bIsHostile : 1;                                           // 0x0018(0x0001) (BlueprintVisible BITFIELD: 0101)
};
...
{
	unsigned char                                      bDetectEnemies : 1;                                       // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0101)
	unsigned char                                      bDetectNeutrals : 1;                                      // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0202)
	unsigned char                                      bDetectFriendlies : 1;                                    // 0x0000(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0404)
};
...
struct FBlackboardEntry
{
	...
	unsigned char                                      bInstanceSynced : 1;                                      // 0x0010(0x0001) (Edit BITFIELD: 0101)
};
...
struct FBlackboardKeySelector
{
	...
	unsigned char                                      bNoneIsAllowedValue : 1;                                  // 0x0024(0x0001) (Edit, BlueprintVisible BITFIELD: 0101)
};
...
struct FEQSParametrizedQueryExecutionRequest
{
	...
	unsigned char                                      bUseBBKeyForQueryTemplate : 1;                            // 0x0044(0x0001) (Edit BITFIELD: 0101)
};
...
struct FEnvTraceData
{
	...
	unsigned char                                      bTraceComplex : 1;                                        // 0x002C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0101)
	unsigned char                                      bOnlyBlockingHits : 1;                                    // 0x002C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0202)
	unsigned char                                      bCanTraceOnNavMesh : 1;                                   // 0x002C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0404)
	unsigned char                                      bCanTraceOnGeometry : 1;                                  // 0x002C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0808)
	unsigned char                                      bCanDisableTrace : 1;                                     // 0x002C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 1010)
	unsigned char                                      bCanProjectDown : 1;                                      // 0x002C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 2020)
};
...
struct FEnvOverlapData
{
	...
	unsigned char                                      bOnlyBlockingHits : 1;                                    // 0x001C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0101)
	unsigned char                                      bOverlapComplex : 1;                                      // 0x001C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0202)
	unsigned char                                      bSkipOverlapQuerier : 1;                                  // 0x001C(0x0001) (Edit, DisableEditOnInstance BITFIELD: 0404)
};
