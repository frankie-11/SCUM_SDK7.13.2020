...
struct ABP_Magazine_SVD_Dragunov_C_SetAmmoCount_Params
{
	int*                                               Amount;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function ConZ.WeaponAttachmentMagazine.Server_InsertCartridgeIntoMagazine
struct ABP_Magazine_SVD_Dragunov_C_Server_InsertCartridgeIntoMagazine_Params
{
...
struct ABP_Magazine_SVD_Dragunov_C_OnRep_AmmoCountOwnerHelper_Params
{
};

// Function ConZ.WeaponAttachmentMagazine.OnRep_AmmoCount
struct ABP_Magazine_SVD_Dragunov_C_OnRep_AmmoCount_Params
{
};

// Function ConZ.WeaponAttachmentMagazine.OnAmmoChangedEvent
struct ABP_Magazine_SVD_Dragunov_C_OnAmmoChangedEvent_Params
{
};

// Function ConZ.WeaponAttachmentMagazine.Multicast_SetLoadedVariables
struct ABP_Magazine_SVD_Dragunov_C_Multicast_SetLoadedVariables_Params
{
	int*                                               ammoCount;                                                // (Parm, ZeroConstructor, IsPlainOldData)
};

// Function ConZ.WeaponAttachmentMagazine.GetProjectileClass
struct ABP_Magazine_SVD_Dragunov_C_GetProjectileClass_Params
{
	class UClass*                                      ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function ConZ.WeaponAttachmentMagazine.GetCapacity
struct ABP_Magazine_SVD_Dragunov_C_GetCapacity_Params
{
	int                                                ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function ConZ.WeaponAttachmentMagazine.GetAmmoCount
struct ABP_Magazine_SVD_Dragunov_C_GetAmmoCount_Params
{
	int                                                ReturnValue;                                              // (Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData)
};

// Function ConZ.WeaponAttachmentMagazine.AddAmmo
struct ABP_Magazine_SVD_Dragunov_C_AddAmmo_Params
{
	int*                                               Amount;                                                   // (Parm, ZeroConstructor, IsPlainOldData)
};
