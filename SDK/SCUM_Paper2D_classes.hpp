...
{
public:
	unsigned char                                      bSampleAdditionalTextures;                                // 0x00F0(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
	int                                                AdditionalSlotIndex;                                      // 0x00F4(0x0004) (Edit, ZeroConstructor, IsPlainOldData)
	struct FText                                       SlotDisplayName;                                          // 0x00F8(0x0018) (Edit)
...
public:
	...
	unsigned char                                      bLooping : 1;                                             // 0x0414(0x0001) ( BITFIELD: 0101)
	unsigned char                                      bReversePlayback : 1;                                     // 0x0414(0x0001) ( BITFIELD: 0202)
	unsigned char                                      bPlaying : 1;                                             // 0x0414(0x0001) ( BITFIELD: 0404)
	...
	struct FScriptMulticastDelegate                    OnFinishedPlaying;                                        // 0x0438(0x0001) (ZeroConstructor, InstancedReference, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0438(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
...
{
public:
	unsigned char                                      bEnableSpriteAtlasGroups;                                 // 0x0028(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bEnableTerrainSplineEditing;                              // 0x0029(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
	unsigned char                                      bResizeSpriteDataToMatchTextures;                         // 0x002A(0x0001) (Edit, ZeroConstructor, Config, IsPlainOldData)
...
{
public:
	unsigned char                                      bClosedSpline;                                            // 0x03E0(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
	unsigned char                                      bFilledSpline;                                            // 0x03E1(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, IsPlainOldData)
...
public:
	...
	unsigned char                                      bHiddenInGame : 1;                                        // 0x0048(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0101)
	unsigned char                                      bLayerCollides : 1;                                       // 0x0048(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0202)
	unsigned char                                      bOverrideCollisionThickness : 1;                          // 0x0048(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0404)
	unsigned char                                      bOverrideCollisionOffset : 1;                             // 0x0048(0x0001) (Edit, BlueprintVisible, BlueprintReadOnly BITFIELD: 0808)
...
public:
	...
	unsigned char                                      bUseSingleLayer;                                          // 0x0444(0x0001) (Edit, ZeroConstructor, IsPlainOldData)
