...
void AJacket_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AJacket_01_C_UpdateMaterialParamsOnClients_Params params;
...
void AJacket_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AJacket_01_C_SetDirtiness_Params params;
