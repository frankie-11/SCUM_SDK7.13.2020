...
bool APenis_C::Use(class APrisoner** Prisoner, int* usage, float* usageWeight, bool* Eat, float* damageMultiplier)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Use");

	APenis_C_Use_Params params;
...
void APenis_C::UpdateVisuals(bool* shouldHandleAging)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.UpdateVisuals");

	APenis_C_UpdateVisuals_Params params;
...
void APenis_C::StaticMeshChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.StaticMeshChangedDelegate__DelegateSignature");

	APenis_C_StaticMeshChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void APenis_C::SkeletalMeshChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.SkeletalMeshChangedDelegate__DelegateSignature");

	APenis_C_SkeletalMeshChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void APenis_C::SetMaxHealth(float* maxHealth)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetMaxHealth");

	APenis_C_SetMaxHealth_Params params;
...
void APenis_C::SetHealthAndUsage(float* health, int* usage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.SetHealthAndUsage");

	APenis_C_SetHealthAndUsage_Params params;
...
void APenis_C::Server_Throw(struct FVector* ZeroBasedStartPosition, struct FRotator* StartRotation, struct FVector* StartVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Server_Throw");

	APenis_C_Server_Throw_Params params;
...
void APenis_C::Repair(float* healthToRepair)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Repair");

	APenis_C_Repair_Params params;
...
TScriptInterface<class UInventoryNode> APenis_C::RemoveStacks(int* stacksToSplit)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.RemoveStacks");

	APenis_C_RemoveStacks_Params params;
...
void APenis_C::PickedUpStateDelegate__DelegateSignature(class AItem** Item, bool* pickedUp)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.PickedUpStateDelegate__DelegateSignature");

	APenis_C_PickedUpStateDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
void APenis_C::OnRep_InventoryContainer2D()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnRep_InventoryContainer2D");

	APenis_C_OnRep_InventoryContainer2D_Params params;
...
void APenis_C::OnProjectileStop(struct FHitResult* ImpactResult)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnProjectileStop");

	APenis_C_OnProjectileStop_Params params;
...
void APenis_C::OnLocalPrisonerPanelsClosed()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnLocalPrisonerPanelsClosed");

	APenis_C_OnLocalPrisonerPanelsClosed_Params params;
...
void APenis_C::OnLocalPrisonerHoveredActorChanged(class AActor** hoveredActor)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnLocalPrisonerHoveredActorChanged");

	APenis_C_OnLocalPrisonerHoveredActorChanged_Params params;
...
void APenis_C::OnEditTextWidgetTextAccepted(class APrisoner** User, struct FText* Text)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnEditTextWidgetTextAccepted");

	APenis_C_OnEditTextWidgetTextAccepted_Params params;
	params.User = User;
	params.Text = Text;
...
void APenis_C::OnDetachedFromItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnDetachedFromItem");

	APenis_C_OnDetachedFromItem_Params params;
	params.Item = Item;
...
void APenis_C::OnDestroyedEvent(class AActor** Self)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnDestroyedEvent");

	APenis_C_OnDestroyedEvent_Params params;
	params.Self = Self;
...
void APenis_C::OnContainedItemDestroyed(class AActor** containedItem)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnContainedItemDestroyed");

	APenis_C_OnContainedItemDestroyed_Params params;
...
void APenis_C::OnAttachedToItem(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.OnAttachedToItem");

	APenis_C_OnAttachedToItem_Params params;
	params.Item = Item;
...
void APenis_C::NetMulticast_SpawnDestroyedEffects()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SpawnDestroyedEffects");

	APenis_C_NetMulticast_SpawnDestroyedEffects_Params params;
...
void APenis_C::NetMulticast_SetPlayerGivenName(struct FString* Value)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SetPlayerGivenName");

	APenis_C_NetMulticast_SetPlayerGivenName_Params params;
	params.Value = Value;
...
void APenis_C::NetMulticast_SetActorDropLocationAndRotation(struct FVector* Location, struct FRotator* Rotation)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.NetMulticast_SetActorDropLocationAndRotation");

	APenis_C_NetMulticast_SetActorDropLocationAndRotation_Params params;
...
void APenis_C::Multicast_UpdateExpirationTime(int64_t* Time)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Multicast_UpdateExpirationTime");

	APenis_C_Multicast_UpdateExpirationTime_Params params;
	params.Time = Time;
...
void APenis_C::Multicast_Throw(struct FVector* ZeroBasedStartPosition, struct FRotator* StartRotation, struct FVector* StartVelocity)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.Multicast_Throw");

	APenis_C_Multicast_Throw_Params params;
	params.ZeroBasedStartPosition = ZeroBasedStartPosition;
	params.StartRotation = StartRotation;
	params.StartVelocity = StartVelocity;
...
bool APenis_C::HasPriorityForContainerItem(class AItem** containerItem)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.HasPriorityForContainerItem");

	APenis_C_HasPriorityForContainerItem_Params params;
...
struct FWidgetDisplayInfo APenis_C::GetWidgetDisplayInfo()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetWidgetDisplayInfo");

	APenis_C_GetWidgetDisplayInfo_Params params;
...
float APenis_C::GetNoiseLoudnessWhenPickedUp()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessWhenPickedUp");

	APenis_C_GetNoiseLoudnessWhenPickedUp_Params params;
...
float APenis_C::GetNoiseLoudnessWhenDropped()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessWhenDropped");

	APenis_C_GetNoiseLoudnessWhenDropped_Params params;
...
float APenis_C::GetNoiseLoudnessOnGroundImpact()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetNoiseLoudnessOnGroundImpact");

	APenis_C_GetNoiseLoudnessOnGroundImpact_Params params;
...
class UMeshComponent* APenis_C::GetMeshComponent()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetMeshComponent");

	APenis_C_GetMeshComponent_Params params;
...
float APenis_C::GetContainerDamagePercentage()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetContainerDamagePercentage");

	APenis_C_GetContainerDamagePercentage_Params params;
...
TArray<class AItem*> APenis_C::GetAllContainedItems(bool* recursive)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.GetAllContainedItems");

	APenis_C_GetAllContainedItems_Params params;
...
bool APenis_C::DropAt(struct FVector* dropLocation, struct FRotator* dropRotation)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.DropAt");

	APenis_C_DropAt_Params params;
...
bool APenis_C::DropAround(class AActor** Actor, float* Radius)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.DropAround");

	APenis_C_DropAround_Params params;
	params.Actor = Actor;
...
void APenis_C::DebugTextChangedDelegate__DelegateSignature(class AItem** Item)
{
	static auto fn = UObject::FindObject<UFunction>("DelegateFunction ConZ.Item.DebugTextChangedDelegate__DelegateSignature");

	APenis_C_DebugTextChangedDelegate__DelegateSignature_Params params;
	params.Item = Item;
...
bool APenis_C::CanStackWith(class UObject** Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanStackWith");

	APenis_C_CanStackWith_Params params;
	params.Item = Item;
...
bool APenis_C::CanBeDroppedBy(class AConZCharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanBeDroppedBy");

	APenis_C_CanBeDroppedBy_Params params;
...
bool APenis_C::CanBeCraftedByCharactrer(class ACharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanBeCraftedByCharactrer");

	APenis_C_CanBeCraftedByCharactrer_Params params;
	params.Character = Character;
...
bool APenis_C::CanAutoAddItem(class AItem** Item, unsigned char* column, unsigned char* row)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanAutoAddItem");

	APenis_C_CanAutoAddItem_Params params;
	params.Item = Item;
...
bool APenis_C::CanAddItem(class AItem** Item, unsigned char* column, unsigned char* row)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.CanAddItem");

	APenis_C_CanAddItem_Params params;
	params.Item = Item;
...
bool APenis_C::AutoAddItemToInventoryNode(TScriptInterface<class UInventoryNode>* Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AutoAddItemToInventoryNode");

	APenis_C_AutoAddItemToInventoryNode_Params params;
	params.Item = Item;
...
bool APenis_C::AttachToCharacterHands(class AConZCharacter** Character)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AttachToCharacterHands");

	APenis_C_AttachToCharacterHands_Params params;
	params.Character = Character;
...
void APenis_C::AddStack(TScriptInterface<class UInventoryNode>* Item)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.Item.AddStack");

	APenis_C_AddStack_Params params;
	params.Item = Item;
