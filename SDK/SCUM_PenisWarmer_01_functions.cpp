...
void APenisWarmer_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	APenisWarmer_01_C_UpdateMaterialParamsOnClients_Params params;
...
void APenisWarmer_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	APenisWarmer_01_C_SetDirtiness_Params params;
...
void APenisWarmer_01_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	APenisWarmer_01_C_OnRep_MaterialParameters_Params params;
