...
public:
	...
	struct FText                                       _defaultTitle;                                            // 0x0318(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FTimerHandle                                _updateNutritionsTimer;                                   // 0x0330(0x0008) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FScriptMulticastDelegate                    BCUBodyMonitorSizeChangedEventDispatcher;                 // 0x0338(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0338(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      _isAlarmOn;                                               // 0x0348(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
