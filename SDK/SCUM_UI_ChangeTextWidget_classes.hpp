...
public:
	...
	unsigned char                                      _isEnabled;                                               // 0x0334(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FText                                       _currentText;                                             // 0x0338(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	...
	void BndEvt__InputText_K2Node_ComponentBoundEvent_0_OnEditableTextCommittedEvent__DelegateSignature(struct FText* Text, TEnumAsByte<ETextCommit>* CommitMethod);
	...
	void STATIC_SetMaxNumberOfCharacters(int* Value);
