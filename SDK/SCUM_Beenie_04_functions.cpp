...
void ABeenie_04_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ABeenie_04_C_UpdateMaterialParamsOnClients_Params params;
...
void ABeenie_04_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ABeenie_04_C_SetDirtiness_Params params;
