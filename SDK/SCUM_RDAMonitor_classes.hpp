...
public:
	...
	struct FText                                       _defaultTitle;                                            // 0x0320(0x0018) (Edit, BlueprintVisible, DisableEditOnInstance)
	struct FVector2D                                   _localSize;                                               // 0x0338(0x0008) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	struct FScriptMulticastDelegate                    RDASizeChangeEventDispatcher;                             // 0x0340(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, BlueprintAssignable)
	unsigned char                                      UnknownData00[0xF];                                       // 0x0340(0x000F) FIX WRONG TYPE SIZE OF PREVIUS PROPERTY
	unsigned char                                      _isAlarmOn;                                               // 0x0350(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData)
	...
	void ExecuteUbergraph_RDAMonitor(int* EntryPoint);
