...
bool ABPC_Weapon_MosinNagant_EVENT_C::STATIC_CanSwitchFiringMode()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Weapon_MosinNagant.BP_Weapon_MosinNagant_C.CanSwitchFiringMode");

	ABPC_Weapon_MosinNagant_EVENT_C_CanSwitchFiringMode_Params params;
...
int ABPC_Weapon_MosinNagant_EVENT_C::GetAmmoReloadCapacity(class AAmmunitionItem** ammo)
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Weapon_MosinNagant.BP_Weapon_MosinNagant_C.GetAmmoReloadCapacity");

	ABPC_Weapon_MosinNagant_EVENT_C_GetAmmoReloadCapacity_Params params;
	params.ammo = ammo;
...
void ABPC_Weapon_MosinNagant_EVENT_C::STATIC_ReceiveBeginPlay()
{
	static auto fn = UObject::FindObject<UFunction>("Function BP_Weapon_MosinNagant.BP_Weapon_MosinNagant_C.ReceiveBeginPlay");

	ABPC_Weapon_MosinNagant_EVENT_C_ReceiveBeginPlay_Params params;
...
void ABPC_Weapon_MosinNagant_EVENT_C::STATIC_ExecuteUbergraph_BP_Weapon_MosinNagant(int* EntryPoint)
{
	...
	ABPC_Weapon_MosinNagant_EVENT_C_ExecuteUbergraph_BP_Weapon_MosinNagant_Params params;
