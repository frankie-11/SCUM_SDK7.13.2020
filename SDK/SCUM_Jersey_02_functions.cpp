...
void AJersey_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AJersey_02_C_UpdateMaterialParamsOnClients_Params params;
...
void AJersey_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AJersey_02_C_SetDirtiness_Params params;
