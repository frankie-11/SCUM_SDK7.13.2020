...
void AWeaponScope_ACOG_01_C::SetZoomLevelOnServer(int* zoomLevel)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetZoomLevelOnServer");

	AWeaponScope_ACOG_01_C_SetZoomLevelOnServer_Params params;
...
void AWeaponScope_ACOG_01_C::SetWindageOnServer(int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetWindageOnServer");

	AWeaponScope_ACOG_01_C_SetWindageOnServer_Params params;
...
void AWeaponScope_ACOG_01_C::SetLoadedVariablesOnClient(int* zoomLevel, int* Windage)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.WeaponAttachmentScope.SetLoadedVariablesOnClient");

	AWeaponScope_ACOG_01_C_SetLoadedVariablesOnClient_Params params;
	params.zoomLevel = zoomLevel;
	params.Windage = Windage;
