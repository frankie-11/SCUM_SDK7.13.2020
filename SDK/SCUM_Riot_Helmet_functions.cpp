...
void ARiot_Helmet_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ARiot_Helmet_C_UpdateMaterialParamsOnClients_Params params;
...
void ARiot_Helmet_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ARiot_Helmet_C_SetDirtiness_Params params;
...
void ARiot_Helmet_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ARiot_Helmet_C_OnRep_MaterialParameters_Params params;
