...
void AJock_Jacket_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AJock_Jacket_02_C_UpdateMaterialParamsOnClients_Params params;
...
void AJock_Jacket_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AJock_Jacket_02_C_SetDirtiness_Params params;
...
void AJock_Jacket_02_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AJock_Jacket_02_C_OnRep_MaterialParameters_Params params;
