...
void ACombatBoots_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ACombatBoots_C_UpdateMaterialParamsOnClients_Params params;
...
void ACombatBoots_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ACombatBoots_C_SetDirtiness_Params params;
...
void ACombatBoots_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ACombatBoots_C_OnRep_MaterialParameters_Params params;
