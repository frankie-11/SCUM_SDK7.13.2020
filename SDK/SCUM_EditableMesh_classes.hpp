...
public:
	...
	void SetEdgesHardness(TArray<struct FEdgeID>* EdgeIDs, TArray<unsigned char>* EdgesNewIsHard);
	...
	struct FTriangleID GetPolygonTriangulatedTriangle(struct FPolygonID* PolygonID, int* PolygonTriangleNumber);
