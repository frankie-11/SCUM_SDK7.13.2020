...
void ASanta_Pants_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ASanta_Pants_C_UpdateMaterialParamsOnClients_Params params;
...
void ASanta_Pants_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ASanta_Pants_C_SetDirtiness_Params params;
...
void ASanta_Pants_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ASanta_Pants_C_OnRep_MaterialParameters_Params params;
