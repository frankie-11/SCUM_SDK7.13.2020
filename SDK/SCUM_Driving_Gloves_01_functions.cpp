...
void ADriving_Gloves_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	ADriving_Gloves_01_C_UpdateMaterialParamsOnClients_Params params;
...
void ADriving_Gloves_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	ADriving_Gloves_01_C_SetDirtiness_Params params;
...
void ADriving_Gloves_01_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	ADriving_Gloves_01_C_OnRep_MaterialParameters_Params params;
...
int ADriving_Gloves_01_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	ADriving_Gloves_01_C_GetCapacityY_Params params;
...
int ADriving_Gloves_01_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	ADriving_Gloves_01_C_GetCapacityX_Params params;
