...
public:
	...
	TArray<struct FLastLocationGatherInfo>             LastGatherLocations;                                      // 0x0190(0x0010) (ZeroConstructor)
	unsigned char                                      UnknownData02[0x8];                                       // 0x01A0(0x0008) MISSED OFFSET
	TArray<class UReplicationGraphNode*>               ConnectionGraphNodes;                                     // 0x01A8(0x0010) (ZeroConstructor)
	class UReplicationGraphNode_TearOff_ForConnection* TearOffNode;                                              // 0x01B8(0x0008) (ZeroConstructor, IsPlainOldData)
...
{
public:
	class UReplicationGraph*                           ReplicationGraph;                                         // 0x0218(0x0008) (ZeroConstructor, IsPlainOldData)
	class UNetReplicationGraphConnection*              ConnectionManager;                                        // 0x0220(0x0008) (ZeroConstructor, IsPlainOldData)
