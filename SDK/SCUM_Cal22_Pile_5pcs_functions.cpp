...
void ACal22_Pile_5pcs_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	ACal22_Pile_5pcs_C_SetAmmoCount_Params params;
	params.count = count;
...
void ACal22_Pile_5pcs_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCountOwnerHelper");

	ACal22_Pile_5pcs_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ACal22_Pile_5pcs_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	ACal22_Pile_5pcs_C_Client_SetAmmoCount_Params params;
	params.count = count;
