...
void AWorking_pants_01_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AWorking_pants_01_C_UpdateMaterialParamsOnClients_Params params;
...
void AWorking_pants_01_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AWorking_pants_01_C_SetDirtiness_Params params;
...
void AWorking_pants_01_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AWorking_pants_01_C_OnRep_MaterialParameters_Params params;
...
int AWorking_pants_01_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AWorking_pants_01_C_GetCapacityY_Params params;
...
int AWorking_pants_01_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AWorking_pants_01_C_GetCapacityX_Params params;
