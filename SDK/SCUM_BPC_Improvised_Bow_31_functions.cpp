...
void ABPC_Improvised_Bow_30_C::ReceiveTick(float* DeltaSeconds)
{
	static auto fn = UObject::FindObject<UFunction>("Function Improvised_Bow.Improvised_Bow_C.ReceiveTick");

	ABPC_Improvised_Bow_30_C_ReceiveTick_Params params;
...
void ABPC_Improvised_Bow_30_C::STATIC_ExecuteUbergraph_Improvised_Bow(int* EntryPoint)
{
	static auto fn = UObject::FindObject<UFunction>("Function Improvised_Bow.Improvised_Bow_C.ExecuteUbergraph_Improvised_Bow");

	ABPC_Improvised_Bow_30_C_ExecuteUbergraph_Improvised_Bow_Params params;
