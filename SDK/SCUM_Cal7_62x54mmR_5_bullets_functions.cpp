...
void ACal7_62x54mmR_5_bullets_C::SetAmmoCount(int* count, bool* replicateToOwner)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.SetAmmoCount");

	ACal7_62x54mmR_5_bullets_C_SetAmmoCount_Params params;
	params.count = count;
...
void ACal7_62x54mmR_5_bullets_C::OnRep_AmmoCountOwnerHelper()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCountOwnerHelper");

	ACal7_62x54mmR_5_bullets_C_OnRep_AmmoCountOwnerHelper_Params params;
...
void ACal7_62x54mmR_5_bullets_C::OnRep_AmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.OnRep_AmmoCount");

	ACal7_62x54mmR_5_bullets_C_OnRep_AmmoCount_Params params;
...
int ACal7_62x54mmR_5_bullets_C::GetAmmoCount()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.GetAmmoCount");

	ACal7_62x54mmR_5_bullets_C_GetAmmoCount_Params params;
...
void ACal7_62x54mmR_5_bullets_C::Client_SetAmmoCount(int* count)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.AmmunitionItem.Client_SetAmmoCount");

	ACal7_62x54mmR_5_bullets_C_Client_SetAmmoCount_Params params;
	params.count = count;
