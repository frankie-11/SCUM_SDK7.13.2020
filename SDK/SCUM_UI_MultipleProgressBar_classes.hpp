...
public:
	...
	struct FText                                       Title1;                                                   // 0x0310(0x0018) (Edit, BlueprintVisible)
	struct FText                                       Title2;                                                   // 0x0328(0x0018) (Edit, BlueprintVisible)
	struct FText                                       Title3;                                                   // 0x0340(0x0018) (Edit, BlueprintVisible)
	struct FText                                       Title4;                                                   // 0x0358(0x0018) (Edit, BlueprintVisible)
	struct FText                                       Title5;                                                   // 0x0370(0x0018) (Edit, BlueprintVisible)
	...
	unsigned char                                      ShowTooltip;                                              // 0x03A0(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData)
