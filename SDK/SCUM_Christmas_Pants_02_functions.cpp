...
void AChristmas_Pants_02_C::UpdateMaterialParamsOnClients()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.UpdateMaterialParamsOnClients");

	AChristmas_Pants_02_C_UpdateMaterialParamsOnClients_Params params;
...
void AChristmas_Pants_02_C::SetDirtiness(float* dirtiness)
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.SetDirtiness");

	AChristmas_Pants_02_C_SetDirtiness_Params params;
...
void AChristmas_Pants_02_C::OnRep_MaterialParameters()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.OnRep_MaterialParameters");

	AChristmas_Pants_02_C_OnRep_MaterialParameters_Params params;
...
int AChristmas_Pants_02_C::GetWarmth()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetWarmth");

	AChristmas_Pants_02_C_GetWarmth_Params params;
...
int AChristmas_Pants_02_C::GetCapacityY()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityY");

	AChristmas_Pants_02_C_GetCapacityY_Params params;
...
int AChristmas_Pants_02_C::GetCapacityX()
{
	static auto fn = UObject::FindObject<UFunction>("Function ConZ.ClothesItem.GetCapacityX");

	AChristmas_Pants_02_C_GetCapacityX_Params params;
